(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === 'object') exports['COS'] = factory();
  else root['COS'] = factory();
})(window, function () {
  ...
  \******************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          /* WEBPACK VAR INJECTION */ (function (module) {
            ...
            !(function (t, e) {
              'object' == (false ? undefined : _typeof(exports)) && 'object' == (false ? undefined : _typeof(module))
                ? (module.exports = e())
                : true
              ...
              return (function (t) {
                ...
                function (t, e, n) {
                  ...
                  Object.defineProperty(e, '__esModule', {
                    ...
                    (e.BEACON_ATTA_REQUEST_URL =
                      e.BEACON_ATTA_TOKEN =
                      e.BEACON_ATTA_ID =
                      e.BEACON_CONFIG_HTTPS_URL =
                      e.BEACON_CONFIG_REQUEST_TIME =
                      e.BEACON_CONFIG =
                      e.BEACON_SENDING_IDS_KEY =
                      e.BEACON_NORMAL_LOG_ID_KEY =
                      e.BEACON_DRIECT_LOG_ID_KEY =
                      e.BEACON_LASE_REPORT_TIME_KEY =
                      e.BEACON_DEVICE_ID_KEY =
                      e.BEACON_STORE_PREFIX =
                      e.BEACON_LOG_ID_KEY =
                      e.BEACON_IS_REALTIME_KEY =
                      e.BEACON_DELAY_DEFAULT =
                      e.BEACON_HTTPS_URL =
                      e.BEACON_HTTP_URL =
                        void 0),
                    (e.BEACON_HTTP_URL = 'http://oth.eve.mdt.qq.com:8080/analytics/v2_upload'),
                    (e.BEACON_HTTPS_URL = 'https://otheve.beacon.qq.com/analytics/v2_upload'),
                    (e.BEACON_DELAY_DEFAULT = 3e3),
                    (e.BEACON_IS_REALTIME_KEY = 'A99'),
                    (e.BEACON_LOG_ID_KEY = 'A100'),
                    (e.BEACON_STORE_PREFIX = '__BEACON_'),
                    (e.BEACON_DEVICE_ID_KEY = '__BEACON_deviceId'),
                    (e.BEACON_LASE_REPORT_TIME_KEY = 'last_report_time'),
                    (e.BEACON_DRIECT_LOG_ID_KEY = 'direct_log_id'),
                    (e.BEACON_NORMAL_LOG_ID_KEY = 'normal_log_id'),
                    (e.BEACON_SENDING_IDS_KEY = 'sending_event_ids'),
                    (e.BEACON_CONFIG = 'beacon_config'),
                    (e.BEACON_CONFIG_REQUEST_TIME = 'beacon_config_request_time'),
                    (e.BEACON_CONFIG_HTTPS_URL =
                      'https://oth.str.beacon.qq.com/trpc.beacon.configserver.BeaconConfigService/QueryConfig'),
                    (e.BEACON_ATTA_ID = '00400014144'),
                    (e.BEACON_ATTA_TOKEN = '6478159937'),
                    (e.BEACON_ATTA_REQUEST_URL = 'https://h.trace.qq.com/kv');
                },
                function (t, e, n) {
                  'use strict';
                  ...
                  var r = n(0),
                    o = (function () {
                      function t(t, e, n, o) {
                        (this.requestParams = {}),
                          (this.network = o),
                          (this.requestParams.attaid = r.BEACON_ATTA_ID),
                          (this.requestParams.token = r.BEACON_ATTA_TOKEN),
                          (this.requestParams.product_id = t.appkey),
                          (this.requestParams.platform = n),
                          (this.requestParams.uin = e.deviceId),
                          (this.requestParams.model = ''),
                          (this.requestParams.os = n),
                          (this.requestParams.app_version = t.appVersion),
                          (this.requestParams.sdk_version = e.sdkVersion),
                          (this.requestParams.error_stack = '');
                      }

                      return (
                        (t.prototype.reportError = function (t, e) {
                          (this.requestParams._dc = Math.random()),
                            (this.requestParams.error_msg = e),
                            (this.requestParams.error_code = t),
                            this.network.get(r.BEACON_ATTA_REQUEST_URL, {
                ...
                function (t, e, n) {
                  ...
                  var r = n(0),
                    o = (function () {
                      ...
                      return (
                        (t.prototype.requestConfig = function (t, e, n) {
                          var o = this;
                          this.storage.setItem(r.BEACON_CONFIG_REQUEST_TIME, Date.now().toString()),
                            n
                              .post(r.BEACON_CONFIG_HTTPS_URL, {
                              ...
                              .then(function (t) {
                                ...
                                else o.processData(null), o.storage.setItem(r.BEACON_CONFIG, '');
                              })
                              ['catch'](function (t) {});
                        }),
                        (t.prototype.processData = function (t) {
                          ...
                          (this.strategy.isEventUpOnOff =
                            null !== (e = null == t ? void 0 : t.isEventUpOnOff) && void 0 !== e
                              ? e
                              : this.strategy.isEventUpOnOff),
                            (this.strategy.httpsUploadUrl =
                              null !== (n = null == t ? void 0 : t.httpsUploadUrl) && void 0 !== n
                                ? n
                                : this.strategy.httpsUploadUrl),
                            (this.strategy.requestInterval =
                              null !== (r = null == t ? void 0 : t.requestInterval) && void 0 !== r
                                ? r
                                : this.strategy.requestInterval),
                            (this.strategy.blacklist =
                              null !== (o = null == t ? void 0 : t.blacklist) && void 0 !== o
                                ? o
                                : this.strategy.blacklist),
                            (this.strategy.samplelist =
                              null !== (i = null == t ? void 0 : t.samplelist) && void 0 !== i
                                ? i
                                : this.strategy.samplelist);
                        ...
                        (t.prototype.isSampleEvent = function (t) {
                          return (
                            !!Object.prototype.hasOwnProperty.call(this.realSample, t) &&
                            this.realSample[t] < Math.floor(Math.random() * Math.floor(1e4))
                          );
                        }),
                        t
                      );
                  ...
                  var _ = wx || qq,
                    h = (function (t) {
                      function e(e) {
                        ...
                        return (
                          (n.send = function (t, e, r) {
                            if (!n.config.appkey) throw new Error('please call init before');
                            n.network
                              .post(n.strategy.getUploadUrl(), t.data)
                              .then(function (r) {
                                100 == r.data.result ? (n.delayTime = 1e3 * r.data.delayTime) : (n.delayTime = 0),
                                  e && e(t.data),
                                  n.cleanEvents(t.data.events);
                              })
                              ['catch'](function (e) {
                                var o = t.data.events;
                                n.errorReport.reportError(e.code ? e.code.toString() : '600', e.message),
                                  r && r(t.data),
                                  n.concatEvents(o);
                              });
                          }),
                          (n.network = new g()),
                          (n.storage = new y(e.appkey)),
                          n.initCommonInfo(e, n),
                          (n.errorReport = new c['default'](n.config, n.commonInfo, 'weapp', n.network)),
                          (n.strategy = new l['default'](n.config, n.commonInfo, n.storage, n.network)),
                          n.storage.setItem(u.BEACON_SENDING_IDS_KEY, JSON.stringify([])),
                          n.onDirectUserAction('rqd_weapp_init', {}),
                          setTimeout(function () {
                            return n.lifeCycle.emit('init');
                          }, 0),
                          (n.initDelayTime = e.delay ? e.delay : 2e3),
                          n.cycleSend(n.initDelayTime),
                          n
                        );
                      }
                      ...
                      return (
                        o(e, t),
                        (e.prototype.initCommonInfo = function (t, e) {
                          _.getNetworkType({
                            ...
                            (this.config.appVersion = t.versionCode ? String(t.versionCode) : ''),
                            (this.config.strictMode = t.strictMode);
                        }),
                        ...
                        (e.prototype.onReport = function (t, e, n) {
                          ...
                          (s = s || 1),
                            ...
                            s++,
                            this.storage.setItem(o, String(s)),
                            r.push({
                              eventCode: t,
                              ...
                              o = {
                                ...
                                common: p.replace(
                                  i(i({}, this.additionalParams), {
                                    ...
                                    A102:
                                      null ===
                                        (n = null === (e = getCurrentPages()) || void 0 === e ? void 0 : e.pop()) ||
                                      void 0 === n
                                        ? void 0
                                        : n.route,
                ...
                function (t, e, n) {
                  ...
                  var o = n(1),
                    ...
                    c = (function () {
                      function t(t) {
                        var e = this;
                        (this.lifeCycle = new o.EventEmiter()),
                          (this.uploadJobQueue = []),
                          (this.additionalParams = {}),
                          (this.delayTime = 0),
                          (this._normalLogPipeline = i.createPipeline([
                            function (t) {
                              e.send(
                                {
                          ...
                          s.assert(Boolean(t.appkey), 'appkey must be initial'),
                          (this.config = r({}, t));
                      }

                      return (
                        (t.prototype.onUserAction = function (t, e) {
                        ...
                        (t.prototype.preReport = function (t, e, n) {
                          t
                            ? this.strategy.isEventUpOnOff() &&
                              (this.strategy.isBlackEvent(t) ||
                                this.strategy.isSampleEvent(t) ||
                                this.onReport(t, e, n))
                        ...
                        (t.prototype.removeSendingId = function (t) {
                          var e = JSON.parse(this.storage.getItem(a.BEACON_SENDING_IDS_KEY)),
                            n = e.indexOf(t);
                          -1 != n &&
                            (e.splice(n, 1), this.storage.setItem(a.BEACON_SENDING_IDS_KEY, JSON.stringify(e)));
                        }),
                        t
                      );
                    })();
 ...
 */
  ...
  \*************************/
        ...
        /***/ function (module, exports) {
          ...
          var element_replace = new RegExp(
            '^([^' +
              element_start_char +
              '])|^((x|X)(m|M)(l|L))|([^' +
              element_start_char +
              element_non_start_char +
              '])',
            'g',
          );
                        ...
                        for (var j in node_data[name]) {
                          if (node_data[name].hasOwnProperty(j))
                            nodes.push(
                              makeNode(
                                name,
                                fn(node_data[name][j], 0, level + 1),
                                null,
                                level + 1,
                                objKeys(node_data[name][j]).length,
                              ),
                            );
                        }
                      } else {
        ...
        /***/ function (module, exports, __webpack_require__) {
          /* WEBPACK VAR INJECTION */ (function (process, global, module) {
            ...
            (function () {
              ...
              var COMMON_JS =
                !root.JS_MD5_NO_COMMON_JS && (false ? undefined : _typeof(module)) === 'object' && module.exports;
              var AMD =
                true &&
                ...
                if (type !== 'string') {
                  if (type === 'object') {
                    if (message === null) {
                      ...
                      ARRAY_BUFFER &&
                      (message.constructor === ArrayBuffer || message.constructor.name === 'ArrayBuffer')
                    ) {
                      message = new Uint8Array(message);
            ...
            this,
            __webpack_require__(/*! ./../node_modules/process/browser.js */ './node_modules/process/browser.js'),
            __webpack_require__(
              ...
              if (elementsCnt > 0) {
                for (var it in jsonObj) {
                  if (
                    ...
                    (jsonObjPath != '' &&
                      !checkJsonObjPropertiesFilter(jsonObj, it, getJsonPropertyPath(jsonObjPath, it)))
                  )
                    continue;
  ...
  \*******************************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          var conventions = __webpack_require__(
            /*! ./conventions */ './node_modules/@xmldom/xmldom/lib/conventions.js',
          );
 ...
 */
  ...
  \**************************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          exports.DOMParser = __webpack_require__(
            /*! ./dom-parser */ './node_modules/@xmldom/xmldom/lib/dom-parser.js',
          ).DOMParser;
  ...
  \************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          module.exports = new Mime(
            __webpack_require__(/*! ./types/standard */ './node_modules/mime/types/standard.js'),
            __webpack_require__(/*! ./types/other */ './node_modules/mime/types/other.js'),
          );
        ...
        /***/ function (module, exports, __webpack_require__) {
          function _regeneratorRuntime() {
            ...
            function wrap(innerFn, outerFn, self, tryLocsList) {
              ...
              return (
                defineProperty(generator, '_invoke', { value: makeInvokeMethod(innerFn, self, context) }), generator
              );
            }
                ...
                function (err, data) {
                  ...
                  var RemoteUploadIdList = util
                    .filter(data.UploadList, function (item) {
                      return (
                        item.Key === Key &&
                        (!StorageClass || item.StorageClass.toUpperCase() === StorageClass.toUpperCase())
                      );
                    })
                    .reverse()
                    .map(function (item) {
 ...
 */
          ...
          function _uploadFile() {
            _uploadFile = _asyncToGenerator(
              /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(params, callback) {
                var self,
                  SliceSize,
                  taskList,
                  FileSize,
                    ...
                    while (1) {
                      switch ((_context.prev = _context.next)) {
                        ...
                        case 12:
                          ...
                          simpleUploadMethod =
                            self.options.SimpleUploadMethod === 'postObject' ? 'postObject' : 'putObject';
          ...
          function _uploadFiles() {
            _uploadFiles = _asyncToGenerator(
              /*#__PURE__*/ _regeneratorRuntime().mark(function _callee3(params, callback) {
                var self,
                  SliceSize,
                  TotalSize,
                  TotalFinish,
                              ...
                              return new Promise(
                                /*#__PURE__*/ (function () {
                                  var _ref = _asyncToGenerator(
                                    /*#__PURE__*/ _regeneratorRuntime().mark(function _callee2(resolve) {
                                      var FileSize,
                                        fileInfo,
                                        accelerate,
                                        _onTaskReady,
                                            ...
                                            switch ((_context2.prev = _context2.next)) {
                                              ...
                                              case 9:
                                                ...
                                                if (self.options.EnableTracker) {
                                                  accelerate =
                                                    self.options.UseAccelerate ||
                                                    (typeof self.options.Domain === 'string' &&
                                                      self.options.Domain.includes('accelerate.'));
                                                ...
                                                simpleUploadMethod =
                                                  self.options.SimpleUploadMethod === 'postObject'
                                                    ? 'postObject'
                                                    : 'putObject';
                                                api = FileSize > SliceSize ? 'sliceUploadFile' : simpleUploadMethod;
                                                taskList.push({
          ...
          function sliceCopyFile(params, callback) {
            ...
            ep.on('get_file_size_finish', function () {
              ...
              TargetHeader['x-cos-storage-class'] =
                params.Headers['x-cos-storage-class'] || SourceHeaders['x-cos-storage-class'];
              ...
              if (
                SourceHeaders['x-cos-storage-class'] === 'ARCHIVE' ||
                SourceHeaders['x-cos-storage-class'] === 'DEEP_ARCHIVE'
              ) {
  ...
  \*********************/
        ...
        /***/ function (module, exports, __webpack_require__) {
              ...
              function (err, data) {
                if (err) {
                  if (
                    err.statusCode === 404 &&
                    err.error &&
                    (err.error === 'Not Found' || err.error.Code === 'NoSuchTagSet')
                  ) {
                    var result = {
                      Tags: [],
                      statusCode: err.statusCode,
          ...
          function putObject(params, callback) {
            ...
            var needCalcMd5 =
              params.UploadAddMetaMd5 || self.options.UploadAddMetaMd5 || self.options.UploadCheckContentMd5;
            var tracker = params.tracker;
            needCalcMd5 &&
              tracker &&
              tracker.setParams({
          ...
          function getObjectAcl(params, callback) {
            ...
            submitRequest.call(
              ...
              function (err, data) {
                ...
                var Owner = AccessControlPolicy.Owner || {};
                var Grant =
                  (AccessControlPolicy.AccessControlList && AccessControlPolicy.AccessControlList.Grant) || [];
                Grant = util.isArray(Grant) ? Grant : [Grant];
                var result = decodeAcl(AccessControlPolicy);
          ...
          var getSignHost = function getSignHost(opt) {
            ...
            var standardHostReg = new RegExp(
          ...
          function getAuthorizationAsync(params, callback) {
            ...
            if (
              StsData.ExpiredTime &&
              StsData.ExpiredTime - util.getSkewTime(self.options.SystemClockOffset) / 1000 > 60
            ) {
          ...
          function allowRetry(err) {
            ...
            var serverDate =
              (err.headers && (err.headers.date || err.headers.Date)) || (err.error && err.error.ServerTime);
          ...
          var initTask = function initTask(cos) {
            ...
            var clearQueue = function clearQueue() {
              ...
              for (
                ...
                var isActive =
                  queue[i].state === 'waiting' || queue[i].state === 'checking' || queue[i].state === 'uploading';
            ...
            _createClass(Tracker, [
              {
                key: 'formatResult',
                value: (function () {
                  var _formatResult = _asyncToGenerator(
                    /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(err, data) {
                      var _err$error,
                        _err$error$error,
                        _err$error2,
                        _err$error2$error,
                              ...
                              case 4:
                                ...
                                errorCode = err
                                  ? (err === null || err === void 0
                                      ...
                                      ? void 0
                                      : (_err$error$error = _err$error.error) === null || _err$error$error === void 0
                                      ? void 0
                                      : _err$error$error.Code) || 'Error'
                                  : '';
                                errorMessage = err
                                  ? (err === null || err === void 0
                                      ? void 0
                                      : (_err$error2 = err.error) === null || _err$error2 === void 0
                                      ? void 0
                                      : (_err$error2$error = _err$error2.error) === null || _err$error2$error === void 0
                                      ? void 0
                                      : _err$error2$error.Message) ||
                                    (err === null || err === void 0
                                      ? void 0
                                      : (_err$error3 = err.error) === null || _err$error3 === void 0
                                      ? void 0
                                      : _err$error3.error) ||
                                ...
                                errorStatusCode = err
                                  ? err === null || err === void 0
                                    ? void 0
                                    : (_err$error4 = err.error) === null || _err$error4 === void 0
                                    ? void 0
                                    : _err$error4.statusCode
                                  : data.statusCode;
                                errorServiceName = err
                                  ? err === null || err === void 0
                                    ? void 0
                                    : (_err$error5 = err.error) === null || _err$error5 === void 0
                                    ? void 0
                                    : (_err$error5$error = _err$error5.error) === null || _err$error5$error === void 0
                                    ? void 0
                                    : _err$error5$error.Resource
                                  : '';
                                requestId = err
                                  ? (err === null || err === void 0
                                      ? void 0
                                      : (_err$error6 = err.error) === null || _err$error6 === void 0
                                      ? void 0
                                      : _err$error6.RequestId) || ''
                                  : (data === null || data === void 0 ? void 0 : data.RequestId) || '';
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var getAuth = function getAuth(opt) {
            ...
            var formatString = [
              method,
              pathname,
              util.obj2str(queryParams, true),
              util.obj2str(headers, true),
              '',
            ].join('\n'); // 步骤三：计算 StringToSign
          ...
          var getSourceParams = function getSourceParams(source) {
            ...
            var m = source.match(
              /^([^.]+-\d+)\.cos(v6|-cdc|-internal)?\.([^.]+)\.((myqcloud\.com)|(tencentcos\.cn))\/(.+)$/,
            );
            if (!m) return null;
            return {
              Bucket: m[1],
            ...
            return function (params, callback) {
              ...
              if (self.options.EnableTracker) {
                if (params.calledBySdk === 'sliceUploadFile') {
                  ...
                  tracker =
                    params.tracker &&
                    params.tracker.generateSubTracker({
                      apiName: apiName,
                    });
                  ...
                  if (params.Body) {
                    fileSize =
                      typeof params.Body === 'string'
                        ? params.Body.length
                        : params.Body.size || params.Body.byteLength || -1;
                  }
              ...
              var formatResult = function formatResult(result) {
                if (result && result.headers) {
                  ...
                  result.headers['x-cos-delete-marker'] &&
                    (result.DeleteMarker = result.headers['x-cos-delete-marker']);
                }
          ...
          var getFileSize = /*#__PURE__*/ (function () {
            var _ref = _asyncToGenerator(
              /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(api, params, callback) {
                return _regeneratorRuntime().wrap(
                  function _callee$(_context) {
                    while (1) {
                      switch ((_context.prev = _context.next)) {
