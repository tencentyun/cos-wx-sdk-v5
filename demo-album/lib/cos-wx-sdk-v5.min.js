  ...
  return (function (e) {
    ...
    function (e, t, n) {
      ...
      function i() {
        ...
        var y = Object.getPrototypeOf,
          x = y && y(y(A([])));
        x && x !== t && n.call(x, s) && (v = x);
        var b = (g.prototype = m.prototype = Object.create(v));
        function k(e) {
        ...
        return (
          ...
          (e.mark = function (e) {
            return (
              Object.setPrototypeOf ? Object.setPrototypeOf(e, g) : ((e.__proto__ = g), u(e, l, 'GeneratorFunction')),
          ...
          (T.prototype = {
            ...
            abrupt: function (e, t) {
              ...
              return (
                (a.type = e),
                (a.arg = t),
                r ? ((this.method = 'next'), (this.next = r.finallyLoc), f) : this.complete(a)
              );
            },
      ...
      function h(e, t) {
        var n = [];
        for (var i in e) e.hasOwnProperty(i) && n.push(t ? m(i).toLowerCase() : i);
      ...
      function x(e) {
        return S(e, function (e) {
          return 'object' === r(e) && null !== e ? x(e) : e;
        });
      }
      function b(e, t) {
        return (
                      ...
                      switch ((e.prev = e.next)) {
                        ...
                        case 12:
                          return (
                            ...
                            (e.t0 = e.catch(6)),
                            (n.Body = void 0),
                            o({ error: 'readFile error, '.concat(e.t0) }),
                            e.abrupt('return')
                          );
                        case 17:
                          void 0 !== n.Body
                            ? ((n.ContentLength = n.Body.byteLength), o(null, n.ContentLength))
                            : o({ error: 'missing param Body' }),
                            (e.next = 21);
                          break;
                        case 20:
                          n.FilePath
                            ...
                            : o({ error: 'missing param FilePath' });
                        case 21:
                        case 'end':
                          return e.stop();
                      }
        ...
        R = {
          ...
          apiWrapper: function (e, t) {
            return function (n, i) {
              var o,
                r = this;
              if (('function' == typeof n && ((i = n), (n = {})), (n = _(e, n)), r.options.EnableTracker))
                if ('sliceUploadFile' === n.calledBySdk) o = n.tracker && n.tracker.generateSubTracker({ apiName: e });
                else if (['uploadFile', 'uploadFiles'].includes(e)) o = null;
                else {
                  var a = -1;
                  n.Body && (a = 'string' == typeof n.Body ? n.Body.length : n.Body.size || n.Body.byteLength || -1),
                    (o = new f({
                      bucket: n.Bucket,
                      region: n.Region,
                      apiName: e,
              ...
              var s = function (e) {
                  return (
                    e &&
                      e.headers &&
                      (e.headers['x-cos-request-id'] && (e.RequestId = e.headers['x-cos-request-id']),
                      e.headers['x-ci-request-id'] && (e.RequestId = e.headers['x-ci-request-id']),
                      e.headers['x-cos-version-id'] && (e.VersionId = e.headers['x-cos-version-id']),
                      e.headers['x-cos-delete-marker'] && (e.DeleteMarker = e.headers['x-cos-delete-marker'])),
                    e
                  );
                },
                c = function (e, t) {
                  o && o.formatResult(e, t), i && i(s(e), s(t));
                },
                l = (function () {
                    ...
                    if (n.Bucket) {
                      if (!/^([a-z\d-]+)-(\d+)$/.test(n.Bucket))
                        if (n.AppId) n.Bucket = n.Bucket + '-' + n.AppId;
                          ...
                          if (!r.options.AppId) return 'Bucket should format as "test-1250000000".';
          ...
          binaryBase64: function (e) {
            ...
            for (t = 0, n = e.length / 2; t < n; t++)
              (i = parseInt(e[2 * t] + e[2 * t + 1], 16)), (o += String.fromCharCode(i));
            return p(o);
          },
          extend: b,
          isArray: k,
          ...
          throttleOnProgress: function (e, t) {
            ...
            return function (t, n) {
              if ((t && ((a = t.loaded), (e = t.total)), n)) clearTimeout(i), c();
              else {
                if (i) return;
          ...
          obj2str: function (e, t) {
            ...
            for (n = 0; n < a.length; n++)
              (o = void 0 === e[(i = a[n])] || null === e[i] ? '' : '' + e[i]),
                (i = t ? m(i).toLowerCase() : m(i)),
                (o = m(o) || ''),
                r.push(i + '=' + o);
            return r.join('&');
          },
          getAuth: function (e) {
            var t,
              ...
              a = x(e.Query || e.params || {}),
              c = (function (e) {
                var t = {};
                for (var n in e) {
                  var i = n.toLowerCase();
                  (i.indexOf('x-cos-') > -1 || g.indexOf(i) > -1) && (t[n] = e[n]);
                }
                return t;
              })(x(e.Headers || e.headers || {})),
              l = e.Key || '';
            e.UseRawKey
              ? (t = e.Pathname || e.pathname || '/' + l)
              : 0 !== (t = e.Pathname || e.pathname || l).indexOf('/') && (t = '/' + t);
            ...
            if (
              ...
              var m = n,
                v = o || p + ';' + d,
                y = o || p + ';' + d,
                b = h(c, !0).join(';').toLowerCase(),
                k = h(a, !0).join(';').toLowerCase(),
                C = s.HmacSHA1(y, i).toString(),
              ...
              return [
                ...
                'q-header-list=' + b,
                'q-url-param-list=' + k,
                'q-signature=' + s.HmacSHA1(_, C).toString(),
              ].join('&');
            }
          },
          compareVersion: A,
        ...
        (t.find = function (e, t, n) {
          ...
          for (var i = 0; i < e.length; i++)
            if (Object.prototype.hasOwnProperty.call(e, i)) {
              var o = e[i];
              if (t.call(void 0, o, i, e)) return o;
            }
        }),
        (t.freeze = i),
        (t.MIME_TYPE = o),
    ...
    function (e, t, n) {
      ...
      function u(e, t) {
        ...
        if (!(n instanceof t)) {
          function i() {}
          (i.prototype = t.prototype), l(n, (i = new i())), (e.prototype = n = i);
        }
        n.constructor != e && (n.constructor = e);
      }
      var p = {},
        d = (p.ELEMENT_NODE = 1),
        f = (p.ATTRIBUTE_NODE = 2),
        m = (p.TEXT_NODE = 3),
        h = (p.CDATA_SECTION_NODE = 4),
        g = (p.ENTITY_REFERENCE_NODE = 5),
        v = (p.ENTITY_NODE = 6),
        y = (p.PROCESSING_INSTRUCTION_NODE = 7),
        x = (p.COMMENT_NODE = 8),
        b = (p.DOCUMENT_NODE = 9),
        k = (p.DOCUMENT_TYPE_NODE = 10),
        C = (p.DOCUMENT_FRAGMENT_NODE = 11),
        S = (p.NOTATION_NODE = 12),
        _ = {},
        w = {},
        E =
          ((_.INDEX_SIZE_ERR = ((w[1] = 'Index size error'), 1)),
          (_.DOMSTRING_SIZE_ERR = ((w[2] = 'DOMString size error'), 2)),
          (_.HIERARCHY_REQUEST_ERR = ((w[3] = 'Hierarchy request error'), 3))),
        T =
          ((_.WRONG_DOCUMENT_ERR = ((w[4] = 'Wrong document'), 4)),
          (_.INVALID_CHARACTER_ERR = ((w[5] = 'Invalid character'), 5)),
          (_.NO_DATA_ALLOWED_ERR = ((w[6] = 'No data allowed'), 6)),
          (_.NO_MODIFICATION_ALLOWED_ERR = ((w[7] = 'No modification allowed'), 7)),
          (_.NOT_FOUND_ERR = ((w[8] = 'Not found'), 8))),
        A =
          ((_.NOT_SUPPORTED_ERR = ((w[9] = 'Not supported'), 9)),
          (_.INUSE_ATTRIBUTE_ERR = ((w[10] = 'Attribute in use'), 10)));
      (_.INVALID_STATE_ERR = ((w[11] = 'Invalid state'), 11)),
        (_.SYNTAX_ERR = ((w[12] = 'Syntax error'), 12)),
        (_.INVALID_MODIFICATION_ERR = ((w[13] = 'Invalid modification'), 13)),
        (_.NAMESPACE_ERR = ((w[14] = 'Invalid namespace'), 14)),
        (_.INVALID_ACCESS_ERR = ((w[15] = 'Invalid access'), 15));
      function O(e, t) {
      ...
      function N(e) {
        ...
        if (e._inc != t) {
          ...
          xe(e, 'length', n.length), l(n, e), (e._inc = t);
        }
      }
      function B() {}
      function P(e, t) {
      ...
      function j(e, t, n) {
        var i = P(t, n);
        if (!(i >= 0)) throw new O(T, new Error(e.tagName + '@' + n));
        for (var o = t.length - 1; i < o; ) t[i] = t[++i];
        if (((t.length = o), e)) {
          var r = e.ownerDocument;
          r && (z(r, e, n), (n.ownerElement = null));
        }
      }
      function L() {}
      function M() {}
      ...
      function G(e) {
        return e && e.nodeType === M.DOCUMENT_TYPE_NODE;
      }
      function V(e) {
        return e && e.nodeType === M.ELEMENT_NODE;
      }
      function X(e) {
        return e && e.nodeType === M.TEXT_NODE;
      }
      function W(e, t) {
        var n = e.childNodes || [];
      ...
      function Q(e, t, n) {
        if (
          !(function (e) {
            return (
              e &&
              (e.nodeType === M.DOCUMENT_NODE ||
                e.nodeType === M.DOCUMENT_FRAGMENT_NODE ||
                e.nodeType === M.ELEMENT_NODE)
            );
          })(e)
        )
          throw new O(E, 'Unexpected parent node type ' + e.nodeType);
        if (n && n.parentNode !== e) throw new O(T, 'child not in parent');
        if (
          !(function (e) {
            return (
              e &&
              (V(e) ||
                ...
                G(e) ||
                e.nodeType === M.DOCUMENT_FRAGMENT_NODE ||
                e.nodeType === M.COMMENT_NODE ||
                e.nodeType === M.PROCESSING_INSTRUCTION_NODE)
            );
          })(t) ||
          (G(t) && e.nodeType !== M.DOCUMENT_NODE)
        )
          throw new O(E, 'Unexpected node type ' + t.nodeType + ' for parent node type ' + e.nodeType);
      }
      function J(e, t, n) {
        var i = e.childNodes || [],
          r = t.childNodes || [];
        if (t.nodeType === M.DOCUMENT_FRAGMENT_NODE) {
          var a = r.filter(V);
          if (a.length > 1 || o(r, X)) throw new O(E, 'More than one element or text in fragment');
          if (1 === a.length && !W(e, n)) throw new O(E, 'Element in fragment can not be inserted before doctype');
        }
        if (V(t) && !W(e, n)) throw new O(E, 'Only one element can be added and only after doctype');
        if (G(t)) {
          if (o(i, G)) throw new O(E, 'Only one doctype is allowed');
          var s = o(i, V);
          if (n && i.indexOf(s) < i.indexOf(n)) throw new O(E, 'Doctype can only be inserted before an element');
          if (!n && s) throw new O(E, 'Doctype can not be appended since element is present');
        }
      }
      function $(e, t, n) {
        var i = e.childNodes || [],
        ...
        if (t.nodeType === M.DOCUMENT_FRAGMENT_NODE) {
          var a = r.filter(V);
          if (a.length > 1 || o(r, X)) throw new O(E, 'More than one element or text in fragment');
          if (1 === a.length && !Y(e, n)) throw new O(E, 'Element in fragment can not be inserted before doctype');
        }
        if (V(t) && !Y(e, n)) throw new O(E, 'Only one element can be added and only after doctype');
        if (G(t)) {
          if (
            o(i, function (e) {
              return G(e) && e !== n;
            ...
            throw new O(E, 'Only one doctype is allowed');
          var s = o(i, V);
          if (n && i.indexOf(s) < i.indexOf(n)) throw new O(E, 'Doctype can only be inserted before an element');
        }
      }
      function Z(e, t, n, i) {
        Q(e, t, n), e.nodeType === M.DOCUMENT_NODE && (i || J)(e, t, n);
        var o = t.parentNode;
        if ((o && o.removeChild(t), t.nodeType === C)) {
          var r = t.firstChild;
          if (null == r) return t;
          var a = t.lastChild;
        } else r = a = t;
        ...
        return q(e.ownerDocument || e, e), t.nodeType == C && (t.firstChild = t.lastChild = null), t;
      }
      function ee() {
        this._nsMap = {};
      }
      ...
      function fe(e, t) {
        var n = [],
          ...
          o = i.prefix,
          r = i.namespaceURI;
        if (r && null == o && null == (o = i.lookupPrefix(r))) var a = [{ namespace: r, prefix: null }];
      ...
      function me(e, t, n) {
        var i = e.prefix || '',
          o = e.namespaceURI;
        if (!o) return !1;
        if (('xml' === i && o === r.XML) || o === r.XMLNS) return !1;
      ...
      function ge(e, t, n, i, o) {
        ...
        switch (e.nodeType) {
          case d:
            ...
            if (!(n = r.isHTML(e.namespaceURI) || n) && !e.prefix && e.namespaceURI) {
              for (var p, v = 0; v < a.length; v++)
                if ('xmlns' === a.item(v).name) {
                  p = a.item(v).value;
                  break;
                }
              if (!p)
                for (var S = o.length - 1; S >= 0; S--) {
                  if ('' === (_ = o[S]).prefix && _.namespace === e.namespaceURI) {
                    p = _.namespace;
                    break;
                  }
                }
              if (p !== e.namespaceURI)
                for (S = o.length - 1; S >= 0; S--) {
                  var _;
                  if ((_ = o[S]).namespace === e.namespaceURI) {
                    _.prefix && (u = _.prefix + ':' + l);
                    break;
                  }
                }
            }
            t.push('<', u);
            for (var w = 0; w < s; w++) {
              'xmlns' == (E = a.item(w)).prefix
                ? o.push({ prefix: E.localName, namespace: E.value })
                : 'xmlns' == E.nodeName && o.push({ prefix: '', namespace: E.value });
            }
            for (w = 0; w < s; w++) {
              var E, T, A;
              if (me((E = a.item(w)), 0, o))
                he(t, (T = E.prefix || '') ? 'xmlns:' + T : 'xmlns', (A = E.namespaceURI)),
                  o.push({ prefix: T, namespace: A });
              ge(E, t, n, i, o);
            }
            if (l === u && me(e, 0, o))
              he(t, (T = e.prefix || '') ? 'xmlns:' + T : 'xmlns', (A = e.namespaceURI)),
            ...
            if (c || (n && !/^(?:meta|link|img|br|hr|input)$/i.test(l))) {
              if ((t.push('>'), n && /^script$/i.test(l)))
                for (; c; ) c.data ? t.push(c.data) : ge(c, t, n, i, o.slice()), (c = c.nextSibling);
              else for (; c; ) ge(c, t, n, i, o.slice()), (c = c.nextSibling);
              t.push('</', u, '>');
            } else t.push('/>');
            return;
          case b:
          case C:
            for (c = e.firstChild; c; ) ge(c, t, n, i, o.slice()), (c = c.nextSibling);
            return;
          case f:
            return he(t, e.name, e.value);
          case m:
            return t.push(e.data.replace(/[<&>]/g, U));
          case h:
          ...
          case k:
            var O = e.publicId,
              R = e.systemId;
            if ((t.push('<!DOCTYPE ', e.name), O)) t.push(' PUBLIC ', O), R && '.' != R && t.push(' ', R), t.push('>');
      ...
      function ve(e, t, n) {
        ...
        if ((i || (i = t.cloneNode(!1)), (i.ownerDocument = e), (i.parentNode = null), n))
          for (var o = t.firstChild; o; ) i.appendChild(ve(e, o, n)), (o = o.nextSibling);
        return i;
      }
      function ye(e, t, n) {
        ...
        switch ((t.childNodes && (i.childNodes = new R()), (i.ownerDocument = e), i.nodeType)) {
          case d:
            var a = t.attributes,
              s = (i.attributes = new B()),
              c = a.length;
            s._ownerElement = i;
            for (var l = 0; l < c; l++) i.setAttributeNode(ye(e, a.item(l), !0));
            break;
          case f:
            n = !0;
        }
        if (n) for (var u = t.firstChild; u; ) i.appendChild(ye(e, u, n)), (u = u.nextSibling);
        return i;
      }
      function xe(e, t, n) {
        e[t] = n;
      ...
      (O.prototype = Error.prototype),
        ...
        (R.prototype = {
          ...
          toString: function (e, t) {
            for (var n = [], i = 0; i < this.length; i++) ge(this[i], n, e, t);
            return n.join('');
          },
          filter: function (e) {
        ...
        (B.prototype = {
          ...
          setNamedItem: function (e) {
            ...
            if (t && t != this._ownerElement) throw new O(A);
        ...
        (L.prototype = {
          ...
          createDocument: function (e, t, n) {
            var i = new H();
            if (
              ((i.implementation = this), (i.childNodes = new R()), (i.doctype = n || null), n && i.appendChild(n), t)
            ) {
        ...
        (M.prototype = {
          ...
          replaceChild: function (e, t) {
            Z(this, e, t, $), t && this.removeChild(t);
          },
          ...
          lookupPrefix: function (e) {
            for (var t = this; t; ) {
              var n = t._nsMap;
              if (n) for (var i in n) if (Object.prototype.hasOwnProperty.call(n, i) && n[i] === e) return i;
        ...
        (H.prototype = {
          ...
          insertBefore: function (e, t) {
            ...
            return (
              ...
              null === this.documentElement && e.nodeType === d && (this.documentElement = e),
              e
            );
          },
          removeChild: function (e) {
          ...
          replaceChild: function (e, t) {
            Z(this, e, t, $), (e.ownerDocument = this), t && this.removeChild(t), V(e) && (this.documentElement = e);
          },
          ...
          getElementById: function (e) {
            var t = null;
            return (
              F(this.documentElement, function (n) {
                if (n.nodeType == d && n.getAttribute('id') == e) return (t = n), !0;
              }),
              t
            );
          },
          getElementsByClassName: function (e) {
            ...
            return new I(this, function (n) {
              ...
              return (
                t.length > 0 &&
                  F(n.documentElement, function (o) {
                    if (o !== n && o.nodeType === d) {
          ...
          createElement: function (e) {
            ...
            return (
              ...
              (t.localName = e),
              (t.childNodes = new R()),
              ((t.attributes = new B())._ownerElement = t),
              t
            );
          },
          ...
          createElementNS: function (e, t) {
            ...
            return (
              ...
              (n.tagName = t),
              (n.namespaceURI = e),
              2 == i.length ? ((n.prefix = i[0]), (n.localName = i[1])) : (n.localName = t),
              (o._ownerElement = n),
              n
            );
          },
        ...
        (ee.prototype = {
          ...
          getElementsByTagName: function (e) {
            return new I(this, function (t) {
              ...
              return (
                F(t, function (i) {
                  i === t || i.nodeType != d || ('*' !== e && i.tagName != e) || n.push(i);
                }),
                n
              );
            });
        ...
        (H.prototype.getElementsByTagName = ee.prototype.getElementsByTagName),
        (H.prototype.getElementsByTagNameNS = ee.prototype.getElementsByTagNameNS),
        u(ee, M),
        ...
        u(ie, ne),
        (oe.prototype = { nodeName: '#comment', nodeType: x }),
        u(oe, ne),
        (re.prototype = { nodeName: '#cdata-section', nodeType: h }),
        u(re, ne),
        (ae.prototype.nodeType = k),
        u(ae, M),
        (se.prototype.nodeType = S),
        u(se, M),
        (ce.prototype.nodeType = v),
        u(ce, M),
        (le.prototype.nodeType = g),
        u(le, M),
        (ue.prototype.nodeName = '#document-fragment'),
        (ue.prototype.nodeType = C),
        u(ue, M),
        (pe.prototype.nodeType = y),
        u(pe, M),
        (de.prototype.serializeToString = function (e, t, n) {
        ...
        var t = (e = e || {}).Base64,
          ...
          r = function (e) {
            if (e.length < 2)
              return (t = e.charCodeAt(0)) < 128
                ...
                : o(224 | ((t >>> 12) & 15)) + o(128 | ((t >>> 6) & 63)) + o(128 | (63 & t));
          ...
          h = function (e) {
            var t = e.length,
              n = t % 4,
              r =
                (t > 0 ? i[e.charAt(0)] << 18 : 0) |
                (t > 1 ? i[e.charAt(1)] << 12 : 0) |
                (t > 2 ? i[e.charAt(2)] << 6 : 0) |
                (t > 3 ? i[e.charAt(3)] : 0),
    ...
    function (e, t, n) {
      ...
      var s = n(6),
        ...
        f = { devicePlatform: '', wxVersion: '', wxSystem: '', wxSdkVersion: '' };
      (function () {
        var e = { devicePlatform: '', wxVersion: '', wxSystem: '', wxSdkVersion: '' };
              ...
              wx.getSystemInfo({
                success: function (n) {
                  var i = n.platform,
                    ...
                    r = n.system,
                    a = n.SDKVersion;
                  Object.assign(e, { devicePlatform: i, wxVersion: o, wxSystem: r, wxSdkVersion: a }), t(e);
                },
              });
            } catch (e) {
              t({
                        ...
                        switch ((e.prev = e.next)) {
                          ...
                          case 4:
                            if (
                              ...
                              (y =
                                (t &&
                                  ...
                                  void 0 === s
                                    ? void 0
                                    : s.Message) ||
                                    (null == t || null === (c = t.error) || void 0 === c ? void 0 : c.error) ||
                                    (null == t ? void 0 : t.error))) ||
                                ''),
                              (x = t
                                ? null == t || null === (l = t.error) || void 0 === l
                                  ? void 0
                                  : l.statusCode
                                : n.statusCode),
                              (b = t
                                ...
                                : ''),
                              (k = t
                                ? (null == t || null === (f = t.error) || void 0 === f ? void 0 : f.RequestId) || ''
                                : (null == n ? void 0 : n.RequestId) || ''),
                              (C = t ? (k ? 'Server' : 'Client') : ''),
                              ...
                              !t || (v && y) || (this.params.fullError = t ? JSON.stringify(t) : ''),
                              'getObject' === this.params.name &&
                                (this.params.size = n ? n.headers && n.headers['content-length'] : -1),
                              this.params.reqUrl)
                            )
                              try {
              ...
              value: function () {
                if (!m.includes(this.params.name) || this.deepTracker) {
                  var e,
                    t =
                      ((e = this.params.name),
                      h.includes(e) ? 'cos_upload' : g.includes(e) ? 'cos_download' : 'base_service'),
                    n = (function (e) {
                      var t = {},
                        n =
                          'Success' === e.result
                  ...
                  this.beacon || (this.beacon = u(this.delay || 5e3)),
                    0 === this.params.delay
    ...
    function (e, t, n) {
      var i,
        ...
        s = function () {
          try {
            i.length ? wx.setStorageSync(a, JSON.stringify(i)) : wx.removeStorageSync(a);
          } catch (e) {}
        },
        c = function () {
          if (!i) {
            i = (function () {
              try {
                var e = JSON.parse(wx.getStorageSync(a));
              } catch (e) {}
              return e || (e = []), e;
            })();
        ...
        u = {
          ...
          getFileId: function (e, t, n, i) {
            return e.FilePath && e.size && e.lastModifiedTime && t
              ? r.md5([e.FilePath].join('::')) +
                  '-' +
                  r.md5([e.size, e.mode, e.lastAccessedTime, e.lastModifiedTime, t, n, i].join('::'))
              : null;
          },
    ...
    function (e, t, n) {
      ...
      var i = n(0),
        ...
        u = function (e) {
          (this.options = i.extend(i.clone(l), e || {})),
      ...
      a.init(u, r),
        s.init(u, r),
        (u.util = { md5: i.md5, xml2json: i.xml2json, json2xml: i.json2xml, encodeBase64: i.encodeBase64 }),
        (u.getAuthorization = i.getAuth),
        (u.version = c.version),
        (e.exports = u);
    },
    function (module, exports, __webpack_require__) {
            ...
            if (!this.finalized) {
              ...
              for (var i, o, r = 0, a = e.length, s = this.blocks, c = this.buffer8; r < a; ) {
                if (
                  ...
                  if (ARRAY_BUFFER) for (o = this.start; r < a && o < 64; ++r) c[o++] = e[r];
                  else for (o = this.start; r < a && o < 64; ++r) s[o >> 2] |= e[r] << SHIFT[3 & o++];
                else if (ARRAY_BUFFER)
                  for (o = this.start; r < a && o < 64; ++r)
                    (i = e.charCodeAt(r)) < 128
                      ...
                      : i < 55296 || i >= 57344
                      ? ((c[o++] = 224 | (i >> 12)), (c[o++] = 128 | ((i >> 6) & 63)), (c[o++] = 128 | (63 & i)))
              ...
              this.first
                      ...
                      ((e = ((((e = a[0] - 680876937) << 7) | (e >>> 25)) - 271733879) << 0) ^
                        ((n =
                          ((((n =
                            (-271733879 ^
                              ((i =
                                ((((i = (-1732584194 ^ (2004318071 & e)) + a[1] - 117830708) << 12) | (i >>> 20)) +
                                  e) <<
                                0) &
                                (-271733879 ^ e))) +
                            a[2] -
                ...
                : ((e = this.h0),
                  ...
                  (t =
                    ((((t +=
                      ((e =
                        ((((e += ((i = this.h3) ^ (t & (n ^ i))) + a[0] - 680876936) << 7) | (e >>> 25)) + t) << 0) ^
                        ((n =
                          ((((n +=
                            (t ^
                              ((i = ((((i += (n ^ (e & (t ^ n))) + a[1] - 389564586) << 12) | (i >>> 20)) + e) << 0) &
                                (e ^ t))) +
                            a[2] +
                            606105819) <<
                            17) |
                ...
                (t =
                  ((((t +=
                    ((e = ((((e += (i ^ (t & (n ^ i))) + a[4] - 176418897) << 7) | (e >>> 25)) + t) << 0) ^
                      ((n =
                        ((((n +=
                          (t ^
                            ((i = ((((i += (n ^ (e & (t ^ n))) + a[5] + 1200080426) << 12) | (i >>> 20)) + e) << 0) &
                              (e ^ t))) +
                          a[6] -
                          1473231341) <<
                          17) |
                ...
                (t =
                  ((((t +=
                    ((e = ((((e += (i ^ (t & (n ^ i))) + a[8] + 1770035416) << 7) | (e >>> 25)) + t) << 0) ^
                      ((n =
                        ((((n +=
                          (t ^
                            ((i = ((((i += (n ^ (e & (t ^ n))) + a[9] - 1958414417) << 12) | (i >>> 20)) + e) << 0) &
                              (e ^ t))) +
                          a[10] -
                          42063) <<
                          17) |
                ...
                (t =
                  ((((t +=
                    ((e = ((((e += (i ^ (t & (n ^ i))) + a[12] + 1804603682) << 7) | (e >>> 25)) + t) << 0) ^
                      ((n =
                        ((((n +=
                          (t ^
                            ((i = ((((i += (n ^ (e & (t ^ n))) + a[13] - 40341101) << 12) | (i >>> 20)) + e) << 0) &
                              (e ^ t))) +
                          a[14] -
                          1502002290) <<
                          17) |
                  ...
                  ((((t +=
                    ((i =
                      ((((i +=
                        (t ^
                          (n &
                            ((e = ((((e += (n ^ (i & (t ^ n))) + a[1] - 165796510) << 5) | (e >>> 27)) + t) << 0) ^
                              t))) +
                        a[6] -
                        1069501632) <<
                        9) |
                      ...
                      0) ^
                      (e &
                        ((n = ((((n += (e ^ (t & (i ^ e))) + a[11] + 643717713) << 14) | (n >>> 18)) + i) << 0) ^ i))) +
                    a[0] -
                    373897302) <<
                    20) |
                    (t >>> 12)) +
                  ...
                  ((((t +=
                    ((i =
                      ((((i +=
                        (t ^
                          (n &
                            ((e = ((((e += (n ^ (i & (t ^ n))) + a[5] - 701558691) << 5) | (e >>> 27)) + t) << 0) ^
                              t))) +
                        a[10] +
                        38016083) <<
                        9) |
                      ...
                      0) ^
                      (e &
                        ((n = ((((n += (e ^ (t & (i ^ e))) + a[15] - 660478335) << 14) | (n >>> 18)) + i) << 0) ^ i))) +
                    a[4] -
                    405537848) <<
                    20) |
                    (t >>> 12)) +
                  ...
                  ((((t +=
                    ((i =
                      ((((i +=
                        (t ^
                          (n &
                            ((e = ((((e += (n ^ (i & (t ^ n))) + a[9] + 568446438) << 5) | (e >>> 27)) + t) << 0) ^
                              t))) +
                        a[14] -
                        1019803690) <<
                        9) |
                      ...
                      0) ^
                      (e &
                        ((n = ((((n += (e ^ (t & (i ^ e))) + a[3] - 187363961) << 14) | (n >>> 18)) + i) << 0) ^ i))) +
                    a[8] +
                    1163531501) <<
                    20) |
                    (t >>> 12)) +
                  ...
                  ((((t +=
                    ((i =
                      ((((i +=
                        (t ^
                          (n &
                            ((e = ((((e += (n ^ (i & (t ^ n))) + a[13] - 1444681467) << 5) | (e >>> 27)) + t) << 0) ^
                              t))) +
                        a[2] -
                        51403784) <<
                        9) |
                      ...
                      0) ^
                      (e &
                        ((n = ((((n += (e ^ (t & (i ^ e))) + a[7] + 1735328473) << 14) | (n >>> 18)) + i) << 0) ^ i))) +
                    a[12] -
                    1926607734) <<
                    20) |
                    (t >>> 12)) +
                ...
                (t =
                  ((((t +=
                    ((r =
                      (i =
                        ((((i +=
                          ((o = t ^ n) ^ (e = ((((e += (o ^ i) + a[5] - 378558) << 4) | (e >>> 28)) + t) << 0)) +
                          a[8] -
                          2022574463) <<
                          11) |
                          (i >>> 21)) +
                          e) <<
                        0) ^ e) ^
                      (n = ((((n += (r ^ t) + a[11] + 1839030562) << 16) | (n >>> 16)) + i) << 0)) +
                    a[14] -
                    35309556) <<
                    23) |
                    (t >>> 9)) +
                ...
                (t =
                  ((((t +=
                    ((r =
                      (i =
                        ((((i +=
                          ((o = t ^ n) ^ (e = ((((e += (o ^ i) + a[1] - 1530992060) << 4) | (e >>> 28)) + t) << 0)) +
                          a[4] +
                          1272893353) <<
                          11) |
                          (i >>> 21)) +
                          e) <<
                        0) ^ e) ^
                      (n = ((((n += (r ^ t) + a[7] - 155497632) << 16) | (n >>> 16)) + i) << 0)) +
                    a[10] -
                    1094730640) <<
                    23) |
                    (t >>> 9)) +
                ...
                (t =
                  ((((t +=
                    ((r =
                      (i =
                        ((((i +=
                          ((o = t ^ n) ^ (e = ((((e += (o ^ i) + a[13] + 681279174) << 4) | (e >>> 28)) + t) << 0)) +
                          a[0] -
                          358537222) <<
                          11) |
                          (i >>> 21)) +
                          e) <<
                        0) ^ e) ^
                      (n = ((((n += (r ^ t) + a[3] - 722521979) << 16) | (n >>> 16)) + i) << 0)) +
                    a[6] +
                    76029189) <<
                    23) |
                    (t >>> 9)) +
                ...
                (t =
                  ((((t +=
                    ((r =
                      (i =
                        ((((i +=
                          ((o = t ^ n) ^ (e = ((((e += (o ^ i) + a[9] - 640364487) << 4) | (e >>> 28)) + t) << 0)) +
                          a[12] -
                          421815835) <<
                          11) |
                          (i >>> 21)) +
                          e) <<
                        0) ^ e) ^
                      (n = ((((n += (r ^ t) + a[15] + 530742520) << 16) | (n >>> 16)) + i) << 0)) +
                    a[2] -
                    995338651) <<
                    23) |
                    (t >>> 9)) +
                ...
                (t =
                  ((((t +=
                    ((i =
                      ((((i +=
                        (t ^ ((e = ((((e += (n ^ (t | ~i)) + a[0] - 198630844) << 6) | (e >>> 26)) + t) << 0) | ~n)) +
                        a[7] +
                        1126891415) <<
                        10) |
                        (i >>> 22)) +
                        e) <<
                      0) ^
                      ((n = ((((n += (e ^ (i | ~t)) + a[14] - 1416354905) << 15) | (n >>> 17)) + i) << 0) | ~e)) +
                    a[5] -
                    57434055) <<
                    21) |
                    (t >>> 11)) +
                ...
                (t =
                  ((((t +=
                    ((i =
                      ((((i +=
                        (t ^ ((e = ((((e += (n ^ (t | ~i)) + a[12] + 1700485571) << 6) | (e >>> 26)) + t) << 0) | ~n)) +
                        a[3] -
                        1894986606) <<
                        10) |
                        (i >>> 22)) +
                        e) <<
                      0) ^
                      ((n = ((((n += (e ^ (i | ~t)) + a[10] - 1051523) << 15) | (n >>> 17)) + i) << 0) | ~e)) +
                    a[1] -
                    2054922799) <<
                    21) |
                    (t >>> 11)) +
                ...
                (t =
                  ((((t +=
                    ((i =
                      ((((i +=
                        (t ^ ((e = ((((e += (n ^ (t | ~i)) + a[8] + 1873313359) << 6) | (e >>> 26)) + t) << 0) | ~n)) +
                        a[15] -
                        30611744) <<
                        10) |
                        (i >>> 22)) +
                        e) <<
                      0) ^
                      ((n = ((((n += (e ^ (i | ~t)) + a[6] - 1560198380) << 15) | (n >>> 17)) + i) << 0) | ~e)) +
                    a[13] +
                    1309151649) <<
                    21) |
                    (t >>> 11)) +
                ...
                (t =
                  ((((t +=
                    ((i =
                      ((((i +=
                        (t ^ ((e = ((((e += (n ^ (t | ~i)) + a[4] - 145523070) << 6) | (e >>> 26)) + t) << 0) | ~n)) +
                        a[11] -
                        1120210379) <<
                        10) |
                        (i >>> 22)) +
                        e) <<
                      0) ^
                      ((n = ((((n += (e ^ (i | ~t)) + a[2] + 718787259) << 15) | (n >>> 17)) + i) << 0) | ~e)) +
                    a[9] -
                    343485551) <<
                    21) |
                    (t >>> 11)) +
      ...
      }).call(this, __webpack_require__(12), __webpack_require__(13), __webpack_require__(2)(module));
    },
    function (e, t) {
      var n,
        i,
              ...
              a = (i.WordArray = r.extend({
                ...
                concat: function (e) {
                  ...
                  if (((e = e.sigBytes), this.clamp(), i % 4))
                    for (var o = 0; o < e; o++)
                      t[(i + o) >>> 2] |= ((n[o >>> 2] >>> (24 - (o % 4) * 8)) & 255) << (24 - ((i + o) % 4) * 8);
                  else if (65535 < n.length) for (o = 0; o < e; o += 4) t[(i + o) >>> 2] = n[o >>> 2];
              ...
              p = (i.BufferedBlockAlgorithm = r.extend({
                ...
                _process: function (t) {
                  var n = this._data,
                    ...
                    s = o / (4 * r);
                  if (
                    ((t = (s = t ? e.ceil(s) : e.max((0 | s) - this._minBufferSize, 0)) * r), (o = e.min(4 * t, o)), t)
                  ) {
        ...
        (function () {
          ...
          e.algo.HMAC = e.lib.Base.extend({
            init: function (e, n) {
              ...
              for (
                var r = (this._oKey = n.clone()), a = (this._iKey = n.clone()), s = r.words, c = a.words, l = 0;
                l < i;
                l++
              )
        ...
        o = function (e) {
          ...
          function f(i, c) {
            ...
            if (i.nodeType == t) {
              ...
              for (h = i.childNodes, g = 0; g < h.length; g++) {
                ...
                if (v.nodeType != r) {
                  ...
                  d(m, v.nodeType, y, x) &&
                    ...
                    null == m[y]
                      ? ((m[y] = f(v, x)), u(m, y, x))
                      : (null != m[y] && (m[y] instanceof Array || ((m[y] = [m[y]]), u(m, y, x))),
                        (m[y][m[y].length] = f(v, x))));
                }
              }
              ...
              return (
                null != C && '' != C && (m.__cnt++, (m.__prefix = C)),
                null != m['#text'] &&
                  ((m.__text = m['#text']),
                  m.__text instanceof Array && (m.__text = m.__text.join('\n')),
                  e.stripWhitespaces && (m.__text = m.__text.trim()),
                  delete m['#text'],
                  'property' == e.arrayAccessForm && delete m['#text_asArray'],
                  (m.__text = (function (t, n, i) {
                ...
                null != m['#cdata-section'] &&
                  ((m.__cdata = m['#cdata-section']),
                  delete m['#cdata-section'],
                  'property' == e.arrayAccessForm && delete m['#cdata-section_asArray']),
                0 == m.__cnt && 'text' == e.emptyNodeForm
                  ? (m = '')
                  : 1 == m.__cnt && null != m.__text
                  ? (m = m.__text)
                  : 1 != m.__cnt || null == m.__cdata || e.keepCData
                  ? m.__cnt > 1 &&
                    null != m.__text &&
              ...
              t instanceof Object
                ? (n += (function (t) {
                    ...
                    return (
                      ...
                      null != t.__text && (e.escapeMode ? (n += c(t.__text)) : (n += t.__text)),
                      n
                    );
                  })(t))
          ...
          function C(e, t, n, i) {
            var o = '';
            if (0 == e.length) o += m(e, t, n, !0);
            else
              for (var r = 0; r < e.length; r++)
                (o += m(e[r], t, x(e[r]), !1)), (o += S(e[r], k(i, t))), (o += h(e[r], t));
            return o;
          }
          function S(e, t) {
            var n = '';
            if (v(e) > 0)
              for (var i in e)
                if (!g(e, i) && ('' == t || y(e, i, k(t, i)))) {
                  var o = e[i],
                    r = x(o);
                  if (null == o || null == o) n += m(o, i, r, !0);
                  else if (o instanceof Object)
                    if (o instanceof Array) n += C(o, i, r, t);
                    else if (o instanceof Date) (n += m(o, i, r, !1)), (n += o.toISOString()), (n += h(o, i));
                    else {
                      v(o) > 0 || null != o.__text || null != o.__cdata
                        ? ((n += m(o, i, r, !1)), (n += S(o, k(t, i))), (n += h(o, i)))
                        : (n += m(o, i, r, !0));
                    }
            ...
            if (i) {
              ...
              try {
                (t = n.parseFromString(e, 'text/xml')),
                  null != o && t.getElementsByTagNameNS(o, 'parsererror').length > 0 && (t = null);
              } catch (e) {
                t = null;
              }
            } else
    ...
    function (e, t, n) {
      ...
      function u(e, t, n, o, r, a) {
        function s(e, t, i) {
          n.attributeNames.hasOwnProperty(e) && a.fatalError('Attribute ' + e + ' redefined'),
        ...
        for (var c, l = ++t, u = 0; ; ) {
          ...
          switch (p) {
            ...
            case '"':
              if (3 === u || 1 === u) {
                if (
                  (1 === u && (a.warning('attribute value must after "="'), (c = e.slice(t, l))),
                  (t = l + 1),
                  !((l = e.indexOf(p, t)) > 0))
                )
                ...
                case 2:
                  2 === u && (d = c),
                    4 == u
                      ...
                      : ((i.isHTML(o['']) && d.match(/^(?:disabled|checked|selected)$/i)) ||
            ...
            default:
              if (p <= ' ')
                ...
                switch (u) {
                  case 2:
                    n.tagName;
                    (i.isHTML(o['']) && c.match(/^(?:disabled|checked|selected)$/i)) ||
                      a.warning('attribute "' + c + '" missed value!! "' + c + '" instead2!!'),
                      s(c, c, t),
                      (t = l),
                      (u = 1);
                    break;
      ...
      function p(e, t, n) {
        ...
        var f;
        (f = o.indexOf(':')) > 0
          ? ((u = e.prefix = o.slice(0, f)), (p = e.localName = o.slice(f + 1)))
          : ((u = null), (p = e.localName = o));
        var h = (e.uri = n[u || '']);
        ...
        if (/^(?:script|textarea)$/i.test(n)) {
          ...
          if (/[&<]/.test(a))
            return /^script$/i.test(n)
              ? (o.characters(a, 0, a.length), r)
              : ((a = a.replace(/&#?\w+;/g, i)), o.characters(a, 0, a.length), r);
        }
        return t + 1;
      }
      function f(e, t, n, i) {
        var o = i[n];
        return (
          null == o && ((o = e.lastIndexOf('</' + n + '>')) < t && (o = e.lastIndexOf('</' + n)), (i[n] = o)), o < t
        );
      }
      function m(e, t) {
        for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[n] = e[n]);
                ...
                for (;;) {
                  try {
                    ...
                    switch ((E > w && m(E), e.charAt(E + 1))) {
                      case '/':
                        var O = e.indexOf('>', E + 3),
                          R = e.substring(E + 2, O).replace(/[ \t\n\r]+$/g, ''),
                          I = S.pop();
                        O < 0
                          ? ((R = e.substring(E + 2).replace(/[\s<].*/, '')),
                            r.error('end tag name: ' + R + ' is not complete:' + I.tagName),
                            (O = E + 1 + R.length))
                          : R.match(/\s</) &&
                            ((R = R.replace(/[\s<].*/, '')),
                            r.error('end tag name: ' + R + ' maybe not complete'),
                            (O = E + 1 + R.length));
                        var N = I.localNSMap,
                          B = I.tagName == R;
                        if (B || (I.tagName && I.tagName.toLowerCase() == R.toLowerCase())) {
                          if ((o.endElement(I.uri, I.localName, R), N))
                            for (var P in N) Object.prototype.hasOwnProperty.call(N, P) && o.endPrefixMapping(P);
                          B ||
                            r.fatalError('end tag name: ' + R + ' is not match the current start tagName:' + I.tagName);
                        } else S.push(I);
                        O++;
                        break;
                      case '?':
                      ...
                      default:
                        C && y(E);
                        var D = new v(),
                          j = S[S.length - 1].currentNSMap,
                          L = ((O = u(e, E, D, j, c, r)), D.length);
                        if (
                          (!D.closed &&
                            f(e, O, D.tagName, _) &&
                            ((D.closed = !0), n.nbsp || r.warning('unclosed xml attribute')),
                          C && L)
                        ) {
                          for (var M = l(C, {}), U = 0; U < L; U++) {
                            var F = D[U];
                            y(F.offset), (F.locator = l(C, {}));
                          }
                          (o.locator = M), p(D, o, j) && S.push(D), (o.locator = C);
                        } else p(D, o, j) && S.push(D);
                        i.isHTML(D.uri) && !D.closed ? (O = d(e, O, D.tagName, c, o)) : O++;
                    }
                  } catch (e) {
                    if (e instanceof s) throw e;
                    r.error('element parse error: ' + e), (O = -1);
                  }
                  O > w ? (w = O) : m(Math.max(E, w) + 1);
                }
    ...
    function (e, t) {
      ...
      var i = 'a-zA-Z_À-ÖØ-öø-ÿͰ-ͽͿ-῿‌-‍⁰-↏Ⰰ-⿿、-퟿豈-﷏ﷰ-�',
        ...
        s = function (e, t) {
          var i = function (e, n, i, r, a) {
            ...
            return (
              n && n.length > 0
                ? (l.push('>'), l.push(n), a && l.push(c), l.push('</'), l.push(e), l.push('>'))
                : l.push('/>'),
              l.join('')
            );
          };
                ...
                for (var d in o)
                  if (o.hasOwnProperty(d))
                    if (o[d] instanceof Array)
                      for (var f in o[d])
                        o[d].hasOwnProperty(f) && p.push(i(d, e(o[d][f], 0, c + 1), null, c + 1, a(o[d][f]).length));
                    else p.push(i(d, e(o[d], 0, c + 1), null, c + 1));
      ...
      e.exports = function (e, t) {
        if ((t || (t = { xmlHeader: { standalone: !0 }, prettyPrint: !0, indent: '  ' }), 'string' == typeof e))
          try {
        ...
        return (
          t &&
            ('object' == n(t)
              ? (t.xmlHeader && (i = c(!!t.xmlHeader.standalone)),
            ...
            return (function (e) {
              ...
              function (e, t, n) {
                ...
                Object.defineProperty(t, '__esModule', { value: !0 }),
                  (t.BEACON_ATTA_REQUEST_URL =
                    t.BEACON_ATTA_TOKEN =
                    t.BEACON_ATTA_ID =
                    t.BEACON_CONFIG_HTTPS_URL =
                    t.BEACON_CONFIG_REQUEST_TIME =
                    t.BEACON_CONFIG =
                    t.BEACON_SENDING_IDS_KEY =
                    t.BEACON_NORMAL_LOG_ID_KEY =
                    t.BEACON_DRIECT_LOG_ID_KEY =
                    t.BEACON_LASE_REPORT_TIME_KEY =
                    t.BEACON_DEVICE_ID_KEY =
                    t.BEACON_STORE_PREFIX =
                    t.BEACON_LOG_ID_KEY =
                    t.BEACON_IS_REALTIME_KEY =
                    t.BEACON_DELAY_DEFAULT =
                    t.BEACON_HTTPS_URL =
                    t.BEACON_HTTP_URL =
                      void 0),
                  (t.BEACON_HTTP_URL = 'http://oth.eve.mdt.qq.com:8080/analytics/v2_upload'),
                  (t.BEACON_HTTPS_URL = 'https://otheve.beacon.qq.com/analytics/v2_upload'),
                  (t.BEACON_DELAY_DEFAULT = 3e3),
                  (t.BEACON_IS_REALTIME_KEY = 'A99'),
                  (t.BEACON_LOG_ID_KEY = 'A100'),
                  (t.BEACON_STORE_PREFIX = '__BEACON_'),
                  (t.BEACON_DEVICE_ID_KEY = '__BEACON_deviceId'),
                  (t.BEACON_LASE_REPORT_TIME_KEY = 'last_report_time'),
                  (t.BEACON_DRIECT_LOG_ID_KEY = 'direct_log_id'),
                  (t.BEACON_NORMAL_LOG_ID_KEY = 'normal_log_id'),
                  (t.BEACON_SENDING_IDS_KEY = 'sending_event_ids'),
                  (t.BEACON_CONFIG = 'beacon_config'),
                  (t.BEACON_CONFIG_REQUEST_TIME = 'beacon_config_request_time'),
                  (t.BEACON_CONFIG_HTTPS_URL =
                    'https://oth.str.beacon.qq.com/trpc.beacon.configserver.BeaconConfigService/QueryConfig'),
                  (t.BEACON_ATTA_ID = '00400014144'),
                  (t.BEACON_ATTA_TOKEN = '6478159937'),
                  (t.BEACON_ATTA_REQUEST_URL = 'https://h.trace.qq.com/kv');
              },
              function (e, t, n) {
                'use strict';
                Object.defineProperty(t, '__esModule', { value: !0 }),
              ...
              function (e, t, n) {
                'use strict';
                Object.defineProperty(t, '__esModule', { value: !0 }), (t.createPipeline = void 0);
                var i = function () {};
                ...
                var i = n(0),
                  o = (function () {
                    function e(e, t, n, o) {
                      (this.requestParams = {}),
                        (this.network = o),
                        (this.requestParams.attaid = i.BEACON_ATTA_ID),
                        (this.requestParams.token = i.BEACON_ATTA_TOKEN),
                    ...
                    return (
                      (e.prototype.reportError = function (e, t) {
                        (this.requestParams._dc = Math.random()),
                          ...
                          this.network.get(i.BEACON_ATTA_REQUEST_URL, { params: this.requestParams });
                      }),
                      e
                    );
                  })();
              ...
              function (e, t, n) {
                'use strict';
                Object.defineProperty(t, '__esModule', { value: !0 }), (t.Config = void 0), (t.Config = function () {});
              },
              function (e, t, n) {
                'use strict';
                Object.defineProperty(t, '__esModule', { value: !0 });
                  ...
                  o = (function () {
                    ...
                    return (
                      (e.prototype.requestConfig = function (e, t, n) {
                        var o = this;
                        this.storage.setItem(i.BEACON_CONFIG_REQUEST_TIME, Date.now().toString()),
                          n
                            .post(i.BEACON_CONFIG_HTTPS_URL, {
                            ...
                            .then(function (e) {
                              ...
                              else o.processData(null), o.storage.setItem(i.BEACON_CONFIG, '');
                            })
                            .catch(function (e) {});
                      }),
                      (e.prototype.processData = function (e) {
                        ...
                        (this.strategy.isEventUpOnOff =
                          null !== (t = null == e ? void 0 : e.isEventUpOnOff) && void 0 !== t
                            ? t
                            : this.strategy.isEventUpOnOff),
                          (this.strategy.httpsUploadUrl =
                            null !== (n = null == e ? void 0 : e.httpsUploadUrl) && void 0 !== n
                              ? n
                              : this.strategy.httpsUploadUrl),
                          (this.strategy.requestInterval =
                            null !== (i = null == e ? void 0 : e.requestInterval) && void 0 !== i
                              ? i
                              : this.strategy.requestInterval),
                          (this.strategy.blacklist =
                            null !== (o = null == e ? void 0 : e.blacklist) && void 0 !== o
                              ? o
                              : this.strategy.blacklist),
                          (this.strategy.samplelist =
                            null !== (r = null == e ? void 0 : e.samplelist) && void 0 !== r
                              ? r
                              : this.strategy.samplelist);
                      ...
                      (e.prototype.isSampleEvent = function (e) {
                        return (
                          ...
                          this.realSample[e] < Math.floor(Math.random() * Math.floor(1e4))
                        );
                      }),
                      e
                    );
              ...
              function (e, t, n) {
                ...
                Object.defineProperty(t, '__esModule', { value: !0 }), (t.WeappOpts = void 0);
                var s = a(n(7)),
                  c = a(n(3)),
                  l = n(0),
                  u = n(1),
                ...
                var m = wx || qq,
                  h = (function (e) {
                    function t(t) {
                      ...
                      return (
                        (n.send = function (e, t, i) {
                          ...
                          n.network
                            .post(n.strategy.getUploadUrl(), e.data)
                            .then(function (i) {
                              100 == i.data.result ? (n.delayTime = 1e3 * i.data.delayTime) : (n.delayTime = 0),
                                t && t(e.data),
                                n.cleanEvents(e.data.events);
                            })
                            .catch(function (t) {
                              var o = e.data.events;
                        ...
                        (n.network = new g()),
                        (n.storage = new v(t.appkey)),
                        n.initCommonInfo(t, n),
                        (n.errorReport = new c.default(n.config, n.commonInfo, 'weapp', n.network)),
                        (n.strategy = new d.default(n.config, n.commonInfo, n.storage, n.network)),
                        n.storage.setItem(l.BEACON_SENDING_IDS_KEY, JSON.stringify([])),
                        n.onDirectUserAction('rqd_weapp_init', {}),
                        setTimeout(function () {
                          return n.lifeCycle.emit('init');
                        }, 0),
                        (n.initDelayTime = t.delay ? t.delay : 2e3),
                    ...
                    return (
                      o(t, e),
                      (t.prototype.initCommonInfo = function (e, t) {
                        m.getNetworkType({
                          success: function (e) {
                      ...
                      (t.prototype.onReport = function (e, t, n) {
                        ...
                        (a = a || 1),
                          (t = r(r({}, t), { A99: n ? 'Y' : 'N', A100: String(a), A72: this.commonInfo.sdkVersion })),
                          a++,
                          this.storage.setItem(o, String(a)),
                          i.push({
                            eventCode: e,
                            ...
                            o = {
                              ...
                              common: u.replace(
                                r(r({}, this.additionalParams), {
                                  ...
                                  A102:
                                    null ===
                                      (n = null === (t = getCurrentPages()) || void 0 === t ? void 0 : t.pop()) ||
                                    void 0 === n
                                      ? void 0
                                      : n.route,
                      ...
                      (e.prototype.post = function (e, t, n) {
                        ...
                        return new Promise(function (o, r) {
                          m.request({
                            ...
                            fail: function (e) {
                              var t = { message: e.errMsg, code: '600', request: i };
                              r(t);
                            },
                          });
                        });
                  ...
                  c = (function () {
                    function e(e) {
                      ...
                      (this.lifeCycle = new o.EventEmiter()),
                        ...
                        (this.delayTime = 0),
                        (this._normalLogPipeline = r.createPipeline([
                          function (e) {
                            t.send(
                              {
                        ...
                        a.assert(Boolean(e.appkey), 'appkey must be initial'),
                        (this.config = i({}, e));
                    }
                    return (
                      ...
                      (e.prototype.preReport = function (e, t, n) {
                        e
                          ? this.strategy.isEventUpOnOff() &&
                            (this.strategy.isBlackEvent(e) || this.strategy.isSampleEvent(e) || this.onReport(e, t, n))
              ...
              function (e, t, n) {
                'use strict';
                Object.defineProperty(t, '__esModule', { value: !0 }), (t.EventEmiter = void 0);
                var i = (function () {
                  function e() {
                    var e = this;
              ...
              function (e, t, n) {
                ...
                Object.defineProperty(t, '__esModule', { value: !0 }), o(n(3), t), o(n(4), t), o(n(5), t);
              },
            ]).default;
          }),
          'object' == a(t) && 'object' == a(e)
            ? (e.exports = r())
            : ((i = []), void 0 === (o = 'function' == typeof (n = r) ? n.apply(t, i) : n) || (e.exports = o));
      }).call(this, n(2)(e));
    },
    function (e, t, n) {
      var i = n(8),
        ...
        (e.exports.init = function (e) {
          var t,
            ...
            p =
              ((n = function () {
                (t = 0),
                  e.emit('task-list-update', { list: o.map(a, u) }),
                  e.emit('list-update', { list: o.map(a, u) });
              }),
              function () {
                t || (t = setTimeout(n));
              }),
              ...
              if (!(c >= e.options.FileParallelLimit)) {
                ...
                if (!(l >= a.length)) {
                  ...
                  l++,
                    c++,
                    (n.state = 'checking'),
                    n.params.onTaskStart && n.params.onTaskStart(u(n)),
                  ...
                  r[n.api].call(e, i, function (i, o) {
                    e._isRunningTask(n.id) &&
                      (('checking' !== n.state && 'uploading' !== n.state) ||
                        ...
                        p(),
                        t(),
                        n.callback && n.callback(i, o),
                        'success' === n.state &&
                          (n.params && (delete n.params.UploadData, delete n.params.Body, delete n.params),
                          delete n.callback)),
                      d());
                  }),
                    p(),
            ...
            m = function (t, n) {
              ...
              if (o) {
                ...
                if (('canceled' === n && 'canceled' !== o.state) || ('paused' === n && r) || ('paused' === n && a)) {
                  ...
                  (o.state = n), e.emit('inner-kill-task', { TaskId: t, toState: n });
                  try {
                  ...
                  'canceled' === n && l && i.removeUsing(l),
                    ...
                    a && (c--, f()),
                    'canceled' === n &&
                      (o.params && (delete o.params.UploadData, delete o.params.Body, delete o.params),
                      delete o.callback);
                }
                d();
              }
          ...
          (e._addTasks = function (t) {
            ...
            (e.restartTask = function (e) {
              ...
              !t ||
                ...
                ((t.state = 'waiting'), p(), (l = Math.min(l, t.index)), f());
            }),
    ...
    function (e, t, n) {
      ...
      function a(e) {
        ...
        i && (i = o.isArray(i) ? i : [i]);
        var r = { READ: 0, WRITE: 0, FULL_CONTROL: 0 };
        return (
          i &&
            i.length &&
            o.each(i, function (i) {
              'qcs::cam::anyone:anyone' === i.Grantee.ID ||
              'http://cam.qcloud.com/groups/global/AllUsers' === i.Grantee.URI
                ? (r[i.Permission] = 1)
                : i.Grantee.ID !== e.Owner.ID && t[n[i.Permission]].push('id="' + i.Grantee.ID + '"');
            }),
          r.FULL_CONTROL || (r.WRITE && r.READ)
      ...
      function c(e) {
        ...
        r ||
          ((r =
            ['cn-south', 'cn-south-2', 'cn-north', 'cn-east', 'cn-southwest', 'sg'].indexOf(a) > -1
              ? '{Region}.myqcloud.com'
              : 'cos.{Region}.myqcloud.com'),
          e.ForcePathStyle || (r = '{Bucket}.' + r)),
          (r = (r = r
            .replace(/\{\{AppId\}\}/gi, i)
            .replace(/\{\{Bucket\}\}/gi, n)
            .replace(/\{\{Region\}\}/gi, a)
      ...
      function u(e, t) {
        ...
        o.each(n, function (e, t) {
          ('' === e || ['content-type', 'cache-control'].indexOf(t.toLowerCase()) > -1) && delete n[t],
          ...
          s = function (e, n) {
            a ||
              ...
              n &&
                n.XCosSecurityToken &&
                !n.SecurityToken &&
                (((n = o.clone(n)).SecurityToken = n.XCosSecurityToken), delete n.XCosSecurityToken),
              t && t(e, n));
          },
          c = this,
          l = e.Bucket || '',
        ...
        if (!m) {
          ...
          m = e.Scope || [{ action: h, bucket: l, region: u, prefix: g }];
        }
        ...
        (c._StsCache = c._StsCache || []),
          (function () {
            ...
            for (e = c._StsCache.length - 1; e >= 0; e--) {
              ...
              else if (!t.ScopeLimit || (t.ScopeLimit && t.ScopeKey === v)) {
                f = t;
                break;
              }
            }
        ...
        var y,
          x = function () {
            ...
            f.StartTime && e.Expires
              ...
              : f.StartTime && f.ExpiredTime && (t = f.StartTime + ';' + f.ExpiredTime);
            var i = {
          ...
          b = function (e) {
            if (e.Authorization) {
              ...
              if (!e.SecurityToken && !e.XCosSecurityToken)
                return o.error(new Error('getAuthorization callback params missing "SecurityToken"'));
              ...
              if (e.ExpiredTime && 10 !== e.ExpiredTime.toString().length)
                return o.error(new Error('getAuthorization callback params "ExpiredTime" should be 10 digits'));
              if (e.StartTime && 10 !== e.StartTime.toString().length)
                return o.error(new Error('getAuthorization callback params "StartTime" should be 10 StartTime'));
            }
            return !1;
          };
        if (f.ExpiredTime && f.ExpiredTime - o.getSkewTime(c.options.SystemClockOffset) / 1e3 > 60) x();
          ...
          c.options.getSTS.call(c, { Bucket: l, Region: u }, function (e) {
            ((f = e || {}).Scope = m),
              (f.ScopeKey = v),
        ...
        if (e)
          if (n && i) {
            ...
            this.options.CorrectClockSkew &&
              Math.abs(o.getSkewTime(this.options.SystemClockOffset) - s) >= 3e4 &&
      ...
      function d(e, t) {
        ...
        e.action && (i[e.action] = '');
        var r = e.url || e.Url,
          a = e.SignHost || l.call(this, { Bucket: e.Bucket, Region: e.Region, Url: r }),
          s = e.tracker;
        !(function o(r) {
          var c = n.options.SystemClockOffset;
          s && s.setParams({ signStartTime: new Date().getTime(), retryTimes: r - 1 }),
            u.call(
              n,
              {
                Bucket: e.Bucket || '',
              ...
              function (i, a) {
                i
                  ? t(i)
                  : (s && s.setParams({ signEndTime: new Date().getTime(), httpStartTime: new Date().getTime() }),
                    (e.AuthData = a),
                    f.call(n, e, function (i, a) {
                      s && s.setParams({ httpEndTime: new Date().getTime() }),
                        i && r < 2 && (c !== n.options.SystemClockOffset || p.call(n, i))
                          ? (e.headers &&
                              (delete e.headers.Authorization,
                              delete e.headers.token,
                              delete e.headers.clientIP,
                              delete e.headers.clientUA,
                              e.headers['x-cos-security-token'] && delete e.headers['x-cos-security-token'],
                              e.headers['x-ci-security-token'] && delete e.headers['x-ci-security-token']),
                            o(r + 1))
                          : t(i, a);
                    }));
              },
      ...
      function f(e, t) {
        ...
        if (!r || n._isRunningTask(r)) {
          ...
          n.options.UseAccelerate && (s = 'accelerate'),
            ...
            e.action && (p = p + '?' + e.action),
            e.qsStr && (p = p.indexOf('?') > -1 ? p + '&' + e.qsStr : p + '?' + e.qsStr);
          var g = {
              method: u,
              url: p,
              headers: e.headers,
          ...
          o.isCIHost(p) && (v = 'x-ci-security-token'),
            (g.headers.Authorization = e.AuthData.Authorization),
            e.AuthData.Token && (g.headers.token = e.AuthData.Token),
            e.AuthData.ClientIP && (g.headers.clientIP = e.AuthData.ClientIP),
            e.AuthData.ClientUA && (g.headers.clientUA = e.AuthData.ClientUA),
            e.AuthData.SecurityToken && (g.headers[v] = e.AuthData.SecurityToken),
            g.headers && (g.headers = o.clearKey(g.headers)),
            (g = o.clearKey(g)),
            e.onProgress &&
            ...
            this.options.Timeout && (g.timeout = this.options.Timeout),
            n.options.ForcePathStyle && (g.pathStyle = n.options.ForcePathStyle),
            n.emit('before-send', g);
          var y = g.url.includes('accelerate.'),
            x = g.qs
              ...
              : '',
            b = x ? g.url + '?' + x : g.url;
          e.tracker && e.tracker.setParams({ reqUrl: b, accelerate: y ? 'Y' : 'N' }),
            e.tracker && e.tracker.parent && e.tracker.parent.setParams({ reqUrl: b, accelerate: y ? 'Y' : 'N' });
                  ...
                  c = function (e, a) {
                    if ((r && n.off('inner-kill-task', C), !s)) {
                      ...
                      i && i.statusCode && (c.statusCode = i.statusCode),
                        ...
                        e ? ((e = o.extend(e || {}, c)), t(e, null)) : ((a = o.extend(a || {}, c)), t(null, a)),
                        (k = null);
                    }
                  };
                if (e) c({ error: e });
      ...
      var m = {
        getService: function (e, t) {
          ...
          var n = this.options.ServiceDomain,
            i = e.Region;
          n
            ? ((n = n.replace(/\{\{Region\}\}/gi, i || '').replace(/\{\{.*?\}\}/gi, '')),
              /^[a-zA-Z]+:\/\//.test(n) || (n = 'https://' + n),
              '/' === n.slice(-1) && (n = n.slice(0, -1)))
            : (n = i ? 'https://cos.' + i + '.myqcloud.com' : 'https://service.cos.myqcloud.com');
          n.replace(/^https?:\/\/([^/]+)(\/.*)?$/, '$1'),
            d.call(this, { Action: 'name/cos:GetService', url: n, method: 'GET', headers: e.Headers }, function (e, n) {
              if (e) return t(e);
              var i =
                (n &&
              ...
              t(null, { Buckets: i, Owner: r, statusCode: n.statusCode, headers: n.headers });
            });
        },
        putBucket: function (e, t) {
          ...
          if (e.BucketAZConfig) {
            ...
            i = o.json2xml({ CreateBucketConfiguration: r });
          }
          d.call(
            this,
            {
            ...
            function (i, o) {
              ...
              t(null, { Location: r, statusCode: o.statusCode, headers: o.headers });
            },
          );
        },
        headBucket: function (e, t) {
          d.call(
            this,
            { Action: 'name/cos:HeadBucket', Bucket: e.Bucket, Region: e.Region, headers: e.Headers, method: 'HEAD' },
            function (e, n) {
              t(e, n);
            },
          );
          ...
          (n.prefix = e.Prefix || ''),
            ...
            d.call(
              ...
              function (e, n) {
                ...
                var s = o.clone(i);
                o.extend(s, { Contents: r, CommonPrefixes: a, statusCode: n.statusCode, headers: n.headers }),
                  t(null, s);
              },
            );
        },
        ...
        putBucketAcl: function (e, t) {
          ...
          if (e.AccessControlPolicy) {
            ...
            (a = o.isArray(a) ? a : [a]),
              delete r.Grant,
              delete r.Grants,
              (r.AccessControlList = { Grant: a }),
              (i = o.json2xml({ AccessControlPolicy: r })),
          ...
          d.call(
            ...
            function (e, n) {
              ...
              n.headers && n.headers['x-cos-acl'] && (c.ACL = n.headers['x-cos-acl']),
                (c = o.extend(c, { Owner: r, Grants: s, statusCode: n.statusCode, headers: n.headers })),
                t(null, c);
            },
          );
        },
        putBucketCors: function (e, t) {
          ...
          var r = o.json2xml({ CORSConfiguration: i }),
            a = e.Headers;
          (a['Content-Type'] = 'application/xml'),
            (a['Content-MD5'] = o.binaryBase64(o.md5(r))),
            d.call(
              this,
              {
            ...
            function (e, n) {
              if (e)
                ...
                o.each(a, function (e) {
                  ...
                  t(null, { CORSRules: a, ResponseVary: s, statusCode: n.statusCode, headers: n.headers });
              }
            },
          );
        },
          ...
          d.call(
            ...
            function (e, n) {
              return e && 204 === e.statusCode
                ...
                : e
                ? t(e)
                : void t(null, { statusCode: n.statusCode || e.statusCode, headers: n.headers });
            },
          );
        },
        ...
        getBucketPolicy: function (e, t) {
          d.call(
            ...
            function (e, n) {
              ...
              t(null, { Policy: i, statusCode: n.statusCode, headers: n.headers });
            },
          );
        },
        putBucketPolicy: function (e, t) {
          ...
          (r['Content-Type'] = 'application/json'),
            (r['Content-MD5'] = o.binaryBase64(o.md5(i))),
            d.call(
              this,
              {
        ...
        putBucketTagging: function (e, t) {
          ...
          var r = o.json2xml({ Tagging: { TagSet: { Tag: i } } }),
            a = e.Headers;
          (a['Content-Type'] = 'application/xml'),
            (a['Content-MD5'] = o.binaryBase64(o.md5(r))),
            d.call(
            ...
            function (e, n) {
              if (e)
                ...
                (r = o.clone(o.isArray(r) ? r : [r])),
                  t(null, { Tags: r, statusCode: n.statusCode, headers: n.headers });
              }
            },
          );
        },
          ...
          d.call(
            ...
            function (e, n) {
              if (e)
                ...
                (r = o.clone(o.isArray(r) ? r : [r])),
                  t(null, { Rules: r, statusCode: n.statusCode, headers: n.headers });
              }
            },
          );
        },
            ...
            function (e, n) {
              if (e)
                if (
                  404 !== e.statusCode ||
                  !e.error ||
                  ('Not Found' !== e.error && 'ReplicationConfigurationnotFoundError' !== e.error.Code)
                )
                  t(e);
                else {
                  var i = { ReplicationConfiguration: { Rules: [] }, statusCode: e.statusCode };
                  e.headers && (i.headers = e.headers), t(null, i);
                }
              else
                e || (!n.ReplicationConfiguration && (n.ReplicationConfiguration = {})),
                  n.ReplicationConfiguration.Rule &&
                    ((n.ReplicationConfiguration.Rules = n.ReplicationConfiguration.Rule),
        ...
        putBucketWebsite: function (e, t) {
          if (e.WebsiteConfiguration) {
            ...
            var r = o.json2xml({ WebsiteConfiguration: n }),
              a = e.Headers;
            (a['Content-Type'] = 'application/xml'),
              (a['Content-MD5'] = o.binaryBase64(o.md5(r))),
              d.call(
            ...
            function (e, n) {
              if (e)
                if (404 === e.statusCode && 'NoSuchWebsiteConfiguration' === e.error.Code) {
                  var i = { WebsiteConfiguration: {}, statusCode: e.statusCode };
                  e.headers && (i.headers = e.headers), t(null, i);
                } else t(e);
              else {
                ...
                t(null, { WebsiteConfiguration: r, statusCode: n.statusCode, headers: n.headers });
              }
            },
          );
        },
        ...
        putBucketReferer: function (e, t) {
          if (e.RefererConfiguration) {
            ...
            (r = o.isArray(r) ? r : [r]).length && (n.DomainList = { Domain: r });
            var a = o.json2xml({ RefererConfiguration: n }),
              s = e.Headers;
            (s['Content-Type'] = 'application/xml'),
              (s['Content-MD5'] = o.binaryBase64(o.md5(a))),
              d.call(
                this,
                {
            ...
            function (e, n) {
              if (e)
                ...
                if (r.DomainList) {
                  ...
                  r.DomainList = { Domains: a };
                }
                t(null, { RefererConfiguration: r, statusCode: n.statusCode, headers: n.headers });
              }
            },
          );
        },
        ...
        getBucketDomain: function (e, t) {
          d.call(
            ...
            function (e, n) {
              ...
              (i = o.clone(o.isArray(i) ? i : [i])),
                t(null, { DomainRule: i, statusCode: n.statusCode, headers: n.headers });
            },
          );
        },
        ...
        getBucketOrigin: function (e, t) {
          d.call(
            ...
            function (e, n) {
              ...
              (i = o.clone(o.isArray(i) ? i : [i])),
                t(null, { OriginRule: i, statusCode: n.statusCode, headers: n.headers });
            },
          );
        },
        ...
        putBucketLogging: function (e, t) {
          var n = o.json2xml({ BucketLoggingStatus: e.BucketLoggingStatus || '' }),
            i = e.Headers;
          ...
          d.call(
            ...
            function (e, n) {
              ...
              delete n.BucketLoggingStatus._xmlns,
                t(null, { BucketLoggingStatus: n.BucketLoggingStatus, statusCode: n.statusCode, headers: n.headers });
            },
          );
        },
        putBucketInventory: function (e, t) {
          ...
          var a = o.json2xml({ InventoryConfiguration: n }),
            s = e.Headers;
          (s['Content-Type'] = 'application/xml'),
            (s['Content-MD5'] = o.binaryBase64(o.md5(a))),
            d.call(
        ...
        getBucketInventory: function (e, t) {
          d.call(
            ...
            function (e, n) {
              ...
              t(null, { InventoryConfiguration: i, statusCode: n.statusCode, headers: n.headers });
            },
          );
        },
          ...
          d.call(
            ...
            function (e, n) {
              ...
              (r = o.isArray(r) ? r : [r]),
                ...
                (i.InventoryConfigurations = r),
                o.extend(i, { statusCode: n.statusCode, headers: n.headers }),
                t(null, i);
            },
          );
        },
          ...
          r && r.setParams({ signStartTime: new Date().getTime() }),
            ...
            d.call(
              ...
              function (n, i) {
                if (n) {
                  var r = n.statusCode;
                  return e.Headers['If-Modified-Since'] && r && 304 === r ? t(null, { NotModified: !0 }) : t(n);
                }
                t(null, {
                  Body: i.body,
            ...
            d.call(
              ...
              function (e, n) {
                ...
                delete s.DeleteMarker,
                  delete s.Version,
                  o.extend(s, { DeleteMarkers: r, Versions: a, statusCode: n.statusCode, headers: n.headers }),
                  t(null, s);
              },
            );
        },
        putObject: function (e, t) {
          var n = this,
            ...
            s = e.Headers;
          s['Cache-Control'] || s['cache-control'] || (s['Cache-Control'] = ''),
            s['Content-Type'] ||
              s['content-type'] ||
              (s['Content-Type'] = r.getType(e.Key) || 'application/octet-stream');
          var l = e.UploadAddMetaMd5 || n.options.UploadAddMetaMd5 || n.options.UploadCheckContentMd5,
            u = e.tracker;
          l && u && u.setParams({ md5StartTime: new Date().getTime() }),
            o.getBodyMd5(l, e.Body, function (r) {
              r &&
                (u && u.setParams({ md5EndTime: new Date().getTime() }),
                n.options.UploadCheckContentMd5 && (s['Content-MD5'] = o.binaryBase64(r)),
                (e.UploadAddMetaMd5 || n.options.UploadAddMetaMd5) && (s['x-cos-meta-md5'] = r)),
                void 0 !== e.ContentLength && (s['Content-Length'] = e.ContentLength),
                a(null, !0),
                d.call(
                  n,
                  {
        ...
        postObject: function (e, t) {
          var n = this,
            ...
            r = e.FilePath;
          if (r) {
            for (var a in ((i['Cache-Control'] = e.CacheControl),
            ...
            (i['x-cos-forbid-overwrite'] = e.ForbidOverwrite),
            (i['x-cos-server-side-encryption-customer-algorithm'] = e.SSECustomerAlgorithm),
            (i['x-cos-server-side-encryption-customer-key'] = e.SSECustomerKey),
            (i['x-cos-server-side-encryption-customer-key-MD5'] = e.SSECustomerKeyMD5),
            (i['x-cos-server-side-encryption'] = e.ServerSideEncryption),
            (i['x-cos-server-side-encryption-cos-kms-key-id'] = e.SSEKMSKeyId),
            (i['x-cos-server-side-encryption-context'] = e.SSEContext),
            delete i['Content-Length'],
            delete i['content-length'],
            e))
              a.indexOf('x-cos-meta-') > -1 && (i[a] = e[a]);
            ...
            d.call(
              ...
              function (i, o) {
                ...
                if (o && o.headers) {
                  ...
                  return t(null, { Location: p, statusCode: o.statusCode, headers: a, ETag: l });
                }
                t(null, o);
              },
            );
          ...
          if (r) {
            ...
            d.call(
              ...
              function (e, n) {
                ...
                o.extend(i, { statusCode: n.statusCode, headers: n.headers }), t(null, i);
              },
            );
        ...
        deleteMultipleObject: function (e, t) {
          var n = e.Objects || [],
            i = e.Quiet;
          n = o.isArray(n) ? n : [n];
          var r = o.json2xml({ Delete: { Object: n, Quiet: i || !1 } }),
            a = e.Headers;
          ...
          d.call(
            this,
            { Scope: s, method: 'POST', Bucket: e.Bucket, Region: e.Region, body: r, action: 'delete', headers: a },
            function (e, n) {
              if (e) return t(e);
              ...
              (r = o.isArray(r) ? r : [r]), (a = o.isArray(a) ? a : [a]);
              var s = o.clone(i);
              o.extend(s, { Error: a, Deleted: r, statusCode: n.statusCode, headers: n.headers }), t(null, s);
            },
          );
        },
        ...
        uploadPartCopy: function (e, t) {
          ...
          if (i) {
            ...
            d.call(
              ...
              {
                Scope: [
                  { action: 'name/cos:GetObject', bucket: r, region: a, prefix: s },
                  { action: 'name/cos:PutObject', bucket: e.Bucket, region: e.Region, prefix: e.Key },
                ],
                method: 'PUT',
                Bucket: e.Bucket,
        ...
        multipartInit: function (e, t) {
          ...
          n['Cache-Control'] || n['cache-control'] || (n['Cache-Control'] = ''),
            n['Content-Type'] ||
              n['content-type'] ||
              (n['Content-Type'] = r.getType(e.Key) || 'application/octet-stream'),
            d.call(
              this,
              {
              ...
              function (e, n) {
                return e
                  ? (i && i.parent && i.parent.setParams({ errorNode: 'multipartInit' }), t(e))
                  : (n = o.clone(n || {})) && n.InitiateMultipartUploadResult
                  ? t(null, o.extend(n.InitiateMultipartUploadResult, { statusCode: n.statusCode, headers: n.headers }))
                  : void t(null, n);
              },
            );
        },
        multipartUpload: function (e, t) {
          ...
          o.getFileSize('multipartUpload', e, function () {
            ...
            r && i && i.setParams({ md5StartTime: new Date().getTime() }),
              o.getBodyMd5(r, e.Body, function (a) {
                a &&
                  ((e.Headers['Content-MD5'] = o.binaryBase64(a)),
                  r && i && i.setParams({ md5EndTime: new Date().getTime() })),
                  i && i.setParams({ partNumber: e.PartNumber }),
                  d.call(
                    n,
                    {
                    ...
                    function (e, n) {
                      if (e) return i && i.parent && i.parent.setParams({ errorNode: 'multipartUpload' }), t(e);
                      t(null, { ETag: o.attr(n.headers, 'etag', {}), statusCode: n.statusCode, headers: n.headers });
                    },
                  );
              });
          });
        ...
        multipartComplete: function (e, t) {
          for (var n = this, i = e.UploadId, r = e.Parts, a = e.tracker, s = 0, l = r.length; s < l; s++)
            0 !== r[s].ETag.indexOf('"') && (r[s].ETag = '"' + r[s].ETag + '"');
          var u = o.json2xml({ CompleteMultipartUpload: { Part: r } }),
            p = e.Headers;
          (p['Content-Type'] = 'application/xml'),
            (p['Content-MD5'] = o.binaryBase64(o.md5(u))),
            d.call(
              this,
              {
              ...
              function (i, r) {
                if (i) return a && a.parent && a.parent.setParams({ errorNode: 'multipartComplete' }), t(i);
                var s = c({
                    ForcePathStyle: n.options.ForcePathStyle,
                    protocol: n.options.Protocol,
                    domain: n.options.Domain,
                  ...
                  u = o.extend(l, { Location: s, statusCode: r.statusCode, headers: r.headers });
                t(null, u);
              },
            );
        },
        multipartList: function (e, t) {
          ...
          (n.delimiter = e.Delimiter),
            ...
            (n = o.clearKey(n));
          var i = e.tracker;
          i && i.setParams({ signStartTime: new Date().getTime() }),
            d.call(
              this,
              {
              ...
              function (e, n) {
                if (e) return i && i.parent && i.parent.setParams({ errorNode: 'multipartList' }), t(e);
                ...
                o.extend(s, { statusCode: n.statusCode, headers: n.headers }), t(null, s);
              },
            );
        },
        multipartListPart: function (e, t) {
          ...
          (n.uploadId = e.UploadId),
            ...
            d.call(
              ...
              function (e, n) {
                if (e) return i && i.parent && i.parent.setParams({ errorNode: 'multipartListPart' }), t(e);
        ...
        getObjectUrl: function (e, t) {
          ...
          var s = r;
          if (void 0 !== e.Sign && !e.Sign) return a && (s += '?' + a), t(null, { Url: s }), s;
          var p = l.call(this, { Bucket: e.Bucket, Region: e.Region, UseAccelerate: e.UseAccelerate, Url: r }),
            d = u.call(
              this,
              {
                      ...
                      (n.Authorization.indexOf('q-signature') > -1
                        ? (function (e) {
                            var t = e.match(/q-url-param-list.*?(?=&)/g)[0],
                              n =
                                'q-url-param-list=' +
                                encodeURIComponent(t.replace(/q-url-param-list=/, '')).toLowerCase(),
                              i = new RegExp(t, 'g');
                            return e.replace(i, n);
                          })(n.Authorization)
                        : 'sign=' + encodeURIComponent(n.Authorization))),
                      n.SecurityToken && (i += '&x-cos-security-token=' + n.SecurityToken),
          ...
          return (
            d
              ? ((s += '?' + d.Authorization + (d.SecurityToken ? '&x-cos-security-token=' + d.SecurityToken : '')),
                a && (s += '&' + a))
              : a && (s += '?' + a),
            s
          );
      ...
      e.exports.init = function (e, t) {
        t.transferToTaskMethod(m, 'postObject'),
          t.transferToTaskMethod(m, 'putObject'),
          o.each(m, function (t, n) {
    ...
    function (e, t) {
      ...
      var i = function (e, t) {
        ...
        for (i = 0; i < s.length; i++)
          (r = void 0 === e[(o = s[i])] || null === e[o] ? '' : '' + e[o]),
            (o = t ? n(o).toLowerCase() : n(o)),
            (r = n(r) || ''),
            a.push(o + '=' + r);
        return a.join('&');
      };
      e.exports = function (e, t) {
        var n,
          ...
          u = function (e, n) {
            ...
            t(e, { statusCode: n.statusCode, headers: o }, n.data);
          };
        if (o) {
          var p,
            d = a.match(/^(https?:\/\/[^/]+\/)([^/]*\/?)(.*)$/);
          e.pathStyle
            ? ((p = decodeURIComponent(d[3] || '')), (a = d[1] + d[2]))
            : ((p = decodeURIComponent(d[2] + d[3] || '')), (a = d[1]));
          var f = { key: p, success_action_status: 200, Signature: r.Authorization },
            m = [
              'Cache-Control',
              'Content-Type',
              'Content-Disposition',
          ...
          for (var h in e.headers)
            e.headers.hasOwnProperty(h) &&
              (h.indexOf('x-cos-meta-') > -1 || m.indexOf(h) > -1) &&
              (f[h] = e.headers[h]);
          r['x-cos-acl'] && (f.acl = r['x-cos-acl']),
            ...
            (n = wx.uploadFile({
              ...
              c && c({ loaded: e.totalBytesSent, total: e.totalBytesExpectedToSend, progress: e.progress / 100 });
            });
        } else {
          var g = (e.qs && i(e.qs)) || '';
          ...
          l && Object.assign(v, { enableHttpDNS: !0, httpDNSServiceId: l }), (n = wx.request(v));
        }
        return n;
      };
    },
    ...
    function (e, t, n) {
        ...
        function C(e, t) {
          function i(r, a, s, c) {
            ...
            if ('throw' !== l.type) {
              var u = l.arg,
                p = u.value;
              return p && 'object' == o(p) && n.call(p, '__await')
                ? t.resolve(p.__await).then(
                    function (e) {
                      i('next', e, s, c);
                    },
      ...
      function d(e, t) {
              ...
              if (r < i) {
                ...
                !(function (t, n) {
                  var i = g * (t - 1),
                    ...
                    r = o - i;
                  d[t]
                    ? n(null, { PartNumber: t, ETag: d[t], Size: r })
                    : u.fileSlice(e.FilePath, i, o, function (e) {
                        ...
                        (d[t] = o),
                          1,
                          (y += r),
                          n(null, { PartNumber: t, ETag: o, Size: r }),
                          x({ loaded: y, total: h });
                      });
        ...
        k.on('error', function (e) {
          ...
          k.on('upload_id_available', function (e) {
            ...
            for (var o = 1; o <= v; o++) {
              var r = n[o];
              r ? ((r.PartNumber = o), (r.Uploaded = !0)) : (r = { PartNumber: o, ETag: null, Uploaded: !1 }),
                i.push(r);
            }
            ...
            if (p._isRunningTask(n)) {
              ...
              p.multipartInit(s, function (e, i) {
                if (p._isRunningTask(n)) {
                  ...
                  k.emit('upload_id_available', { UploadId: o, PartList: [] });
                }
              });
            }
          }),
              ...
              c.eachLimit(
                ...
                function (t, a) {
                  p._isRunningTask(n) &&
                    (s.using[t]
                      ? a()
                      : m.call(p, { Bucket: i, Region: o, Key: r, UploadId: t, tracker: e.tracker }, function (e, i) {
                          if (p._isRunningTask(n)) {
                            ...
                            o.forEach(function (e) {
                              ...
                              b(o, function (e, i) {
                                if (p._isRunningTask(n))
                                  return e ? k.emit('error', e) : void (i ? a({ UploadId: t, PartList: o }) : a());
                              });
                          }
                        }));
                },
                function (e) {
                  p._isRunningTask(n) &&
                    (x(null, !0),
                    e && e.UploadId ? k.emit('upload_id_available', e) : k.emit('no_available_upload_id'));
                },
              );
          }),
          k.on('seek_local_avail_upload_id', function (t) {
            ...
            if (a && c) {
              !(function a(l) {
                if (l >= c.length) k.emit('has_and_check_upload_id', t);
                else {
                  var d = c[l];
                  if (!u.isInArray(t, d)) return s.removeUploadId(d), void a(l + 1);
                  s.using[d]
                    ? a(l + 1)
                    : m.call(p, { Bucket: i, Region: o, Key: r, UploadId: d, tracker: e.tracker }, function (e, t) {
                        p._isRunningTask(n) &&
                          (e
                            ? (s.removeUploadId(d), a(l + 1))
                            : k.emit('upload_id_available', { UploadId: d, PartList: t.PartList }));
                      });
                }
              })(0);
          ...
          k.on('get_remote_upload_id_list', function () {
            f.call(p, { Bucket: i, Region: o, Key: r, tracker: e.tracker }, function (t, o) {
              if (p._isRunningTask(n)) {
                ...
                if (c.length) k.emit('seek_local_avail_upload_id', c);
                else {
                  var l,
                    d = s.getFileId(e.FileStat, e.ChunkSize, i, r);
                  d &&
                    (l = s.getUploadIdList(d)) &&
                    u.each(l, function (e) {
                      s.removeUploadId(e);
                    }),
      ...
      function f(e, t) {
        ...
        !(function e() {
          n.multipartList(o, function (n, r) {
            if (n) return t(n);
            i.push.apply(i, r.Upload || []),
              'true' === r.IsTruncated
                ? ((o.KeyMarker = r.NextKeyMarker), (o.UploadIdMarker = r.NextUploadIdMarker), e())
                : t(null, { UploadList: i });
          });
        })();
      }
      function m(e, t) {
        ...
        !(function e() {
          n.multipartListPart(o, function (n, r) {
            if (n) return t(n);
            i.push.apply(i, r.Part || []),
              'true' === r.IsTruncated
                ? ((o.PartNumberMarker = r.NextPartNumberMarker), e())
                : t(null, { PartList: i });
          });
        })();
      }
              ...
              g.call(
                n,
                {
                  ...
                  onProgress: function (e) {
                    (h += e.loaded - m), (m = e.loaded), x({ loaded: h, total: l });
                  },
                  tracker: e.tracker,
                },
                function (e, o) {
                  n._isRunningTask(i) &&
                    (e ? (h -= m) : ((h += d - m), (t.ETag = o.ETag)), x({ loaded: h, total: l }), c(e || null, o));
                },
              );
            }
          },
          function (e) {
            if (n._isRunningTask(i)) return e ? t(e) : void t(null, { UploadId: s.UploadId, SliceList: s.PartList });
          },
        );
      }
      function g(e, t) {
      ...
      function y(e, t) {
        ...
        c.eachLimit(
          ...
          function (t, r) {
            var a = l;
            if (o && o !== t.Key) return (u[a] = { error: { KeyNotMatch: !0 } }), void r(null);
            var c = t.UploadId || t.UploadID;
            s.multipartAbort({ Bucket: n, Region: i, Key: t.Key, Headers: e.Headers, UploadId: c }, function (e) {
              var o = { Bucket: n, Region: i, Key: t.Key, UploadId: c };
              (u[a] = { error: e, task: o }), r(null);
            }),
              l++;
          },
          function (e) {
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        (r = this),
                        (a = void 0 === t.SliceSize ? r.options.SliceSize : t.SliceSize),
                        (s = []),
                        (e.prev = 3),
                        (e.next = 6),
                        u.getFileSizeByPath(t.FilePath)
                      );
                    case 6:
                      (c = e.sent), (e.next = 12);
                      break;
                    case 9:
                      (e.prev = 9), (e.t0 = e.catch(3)), n({ error: e.t0 });
                    case 12:
                      (l = { TaskId: '' }),
                        r.options.EnableTracker &&
                          ((d =
                            r.options.UseAccelerate ||
                            ('string' == typeof r.options.Domain && r.options.Domain.includes('accelerate.'))),
                          (t.tracker = new p({
                            bucket: t.Bucket,
                            region: t.Region,
                            apiName: 'uploadFile',
                        ...
                        (g = 'postObject' === r.options.SimpleUploadMethod ? 'postObject' : 'putObject'),
                        (v = c > a ? 'sliceUploadFile' : g),
                        s.push({ api: v, params: t, callback: h }),
                        r._addTasks(s);
                    case 23:
                    case 'end':
                      return e.stop();
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          (r = this),
                          (s = void 0 === t.SliceSize ? r.options.SliceSize : t.SliceSize),
                          (c = 0),
                          (l = 0),
                          (d = u.throttleOnProgress.call(r, l, t.onProgress)),
                          (f = t.files.length),
                          (m = t.onFileFinish),
                          (h = Array(f)),
                          (g = function (e, t, i) {
                            d(null, !0),
                              m && m(e, t, i),
                              (h[i.Index] = { options: i, error: e, data: t }),
                              --f <= 0 && n && n(null, { files: h });
                          }),
                          (v = []),
                          (y = function () {
                                        ...
                                        function (n) {
                                          for (;;)
                                            switch ((n.prev = n.next)) {
                                              case 0:
                                                return (
                                                  (f = 0), (n.prev = 1), (n.next = 4), u.getFileSizeByPath(e.FilePath)
                                                );
                                              case 4:
                                                (f = n.sent), (n.next = 9);
                                                break;
                                              ...
                                              case 9:
                                                (m = { Index: t, TaskId: '' }),
                                                  ...
                                                  r.options.EnableTracker &&
                                                    ((h =
                                                      r.options.UseAccelerate ||
                                                      ('string' == typeof r.options.Domain &&
                                                        r.options.Domain.includes('accelerate.'))),
                                                    (e.tracker = new p({
                                                      bucket: e.Bucket,
                                                      region: e.Region,
                                                      apiName: 'uploadFiles',
                                                  ...
                                                  (S =
                                                    'postObject' === r.options.SimpleUploadMethod
                                                      ? 'postObject'
                                                      : 'putObject'),
                                                  (_ = f > s ? 'sliceUploadFile' : S),
                                                  v.push({ api: _, params: e, callback: C }),
                                                  a(!0);
                                              case 24:
                                              case 'end':
                                                return n.stop();
      ...
      var C = {
        sliceUploadFile: function (e, t) {
          ...
          if (!u.canFileSlice())
            return (
              (e.SkipTask = !0),
              void ('postObject' === n.options.SimpleUploadMethod ? n.postObject(e, t) : n.putObject(e, t))
            );
          var i,
            o,
            r = new l(),
            ...
            k = e.onHashProgress,
            C = e.tracker;
          C && C.setParams({ chunkSize: g }),
            r.on('error', function (i) {
              if (n._isRunningTask(a)) {
                var o = { UploadId: e.UploadData.UploadId || '', err: i, error: i };
                return t(o);
              }
            }),
            r.on('upload_complete', function (n) {
              var i = u.extend({ UploadId: e.UploadData.UploadId || '' }, n);
              t(null, i);
            }),
            r.on('upload_slice_complete', function (e) {
              v.call(
                n,
                { Bucket: c, Region: p, Key: f, UploadId: e.UploadId, SliceList: e.SliceList, tracker: C },
                function (t, c) {
                  if (n._isRunningTask(a)) {
                    if ((s.removeUsing(e.UploadId), t)) return o(null, !0), r.emit('error', t);
                    s.removeUploadId(e.UploadId), o({ loaded: i, total: i }, !0), r.emit('upload_complete', c);
                  }
                },
              );
            }),
            r.on('get_upload_data_finish', function (t) {
              ...
              l && s.saveUploadId(l, t.UploadId, n.options.UploadIdCacheLimit),
                s.setUsing(t.UploadId),
                o(null, !0),
                h.call(
                  n,
                  {
                  ...
                  function (e, t) {
                    if (n._isRunningTask(a))
                      return e ? (o(null, !0), r.emit('error', e)) : void r.emit('upload_slice_complete', t);
                  },
                );
            }),
            r.on('get_file_size_finish', function () {
              if (((o = u.throttleOnProgress.call(n, i, e.onProgress)), e.UploadData.UploadId))
                r.emit('get_upload_data_finish', e.UploadData);
              else {
                var t = u.extend(
                  {
                    TaskId: a,
            ...
            !e.Headers && (e.Headers = {}),
            u.each(e.Headers, function (t, n) {
              'content-length' === n.toLowerCase() && delete e.Headers[n];
            }),
            (function () {
              for (
                var t = [1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 5120], o = 1048576, r = 0;
                r < t.length && !(i / (o = 1024 * t[r] * 1024) <= n.options.MaxPartNumber);
                r++
              );
        ...
        abortUploadTask: function (e, t) {
          ...
          if (
            ...
            u.on('get_abort_array', function (r) {
              y.call(
                c,
                { Bucket: n, Region: i, Key: o, Headers: e.Headers, AsyncLimit: s, AbortArray: r },
                function (e, n) {
                  if (e) return t(e);
                  t(null, n);
                },
            ...
            f.call(c, { Bucket: n, Region: i, calledBySdk: 'abortUploadTask' }, function (e, n) {
              if (e) return t(e);
              u.emit('get_abort_array', n.UploadList || []);
            });
          else if ('file' === a) {
            if (!o) return t({ error: 'abort_upload_task_no_key' });
            f.call(c, { Bucket: n, Region: i, Key: o, calledBySdk: 'abortUploadTask' }, function (e, n) {
              if (e) return t(e);
              u.emit('get_abort_array', n.UploadList || []);
            });
          } else {
            if ('task' !== a) return t({ error: 'abort_unknown_level' });
            if (!r) return t({ error: 'abort_upload_task_no_id' });
            if (!o) return t({ error: 'abort_upload_task_no_key' });
            u.emit('get_abort_array', [{ Key: o, UploadId: r }]);
          }
        },
          ...
          if (d) {
            ...
            n.on('copy_slice_complete', function (n) {
              ...
              c.retry(
                ...
                function (e) {
                  i.multipartComplete(
                    { Bucket: o, Region: r, Key: a, UploadId: n.UploadId, Parts: p, calledBySdk: 'sliceCopyFile' },
                    e,
                  );
                },
                function (e, i) {
                  if ((s.removeUsing(n.UploadId), e)) return x(null, !0), t(e);
                  s.removeUploadId(n.UploadId), x({ loaded: y, total: y }, !0), t(null, i);
                },
              );
            }),
                ...
                c.eachLimit(
                  ...
                  function (t, n) {
                    ...
                    c.retry(
                      ...
                      function (t) {
                        k.call(
                          i,
                          {
                            ...
                            CopySourceRange: l,
                            onProgress: function (e) {
                              (w += e.loaded - d), (d = e.loaded), x({ loaded: w, total: y });
                            },
                          },
                          t,
                        );
                      ...
                      function (e, i) {
                        if (e) return n(e);
                        x({ loaded: w, total: y }), (w += u - d), (t.ETag = i.ETag), n(e || null, i);
                      },
                    );
                  },
                  function (i) {
              ...
              n.on('get_chunk_size_finish', function () {
                var c = function () {
                    i.multipartInit({ Bucket: o, Region: r, Key: a, Headers: A }, function (i, o) {
                      if (i) return t(i);
                      (e.UploadId = o.UploadId),
                        n.emit('get_copy_data_finish', { UploadId: e.UploadId, PartList: e.PartList });
                    });
                  },
                ...
                !(function t(l) {
                  ...
                  m.call(i, { Bucket: o, Region: r, Key: a, UploadId: p }, function (i, o) {
                    if (i) s.removeUploadId(p), t(l + 1);
                    else {
                      if (s.using[p]) return t(l + 1);
                      var r = {},
                        a = 0;
                      u.each(o.PartList, function (e) {
                        ...
                        n.emit('get_copy_data_finish', { UploadId: p, PartList: e.PartList });
                    }
                  });
                })(0);
              }),
              n.on('get_file_size_finish', function () {
                ...
                if (
                  ((function () {
                    for (
                      var t = [1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 5120], n = 1048576, o = 0;
                      o < t.length && !(y / (n = 1024 * t[o] * 1024) <= i.options.MaxPartNumber);
                      o++
                    );
                    ...
                    for (var r = [], a = 1; a <= _; a++) {
                      var s = (a - 1) * b,
                        c = a * b < y ? a * b - 1 : y - 1,
                        l = { PartNumber: a, start: s, end: c, CopySourceRange: 'bytes=' + s + '-' + c };
                      r.push(l);
                    }
                    e.PartList = r;
                  })(),
                  ((o = 'Replaced' === e.Headers['x-cos-metadata-directive'] ? e.Headers : T)['x-cos-storage-class'] =
                    e.Headers['x-cos-storage-class'] || T['x-cos-storage-class']),
                  (o = u.clearKey(o)),
                  'ARCHIVE' === T['x-cos-storage-class'] || 'DEEP_ARCHIVE' === T['x-cos-storage-class'])
                ) {
                  var r = T['x-cos-restore'];
                  if (!r || 'ongoing-request="true"' === r)
                    return void t({ error: 'Unrestored archive object is not allowed to be copied' });
                }
                delete o['x-cos-copy-source'],
                  delete o['x-cos-metadata-directive'],
                  delete o['x-cos-copy-source-If-Modified-Since'],
                  delete o['x-cos-copy-source-If-Unmodified-Since'],
                  delete o['x-cos-copy-source-If-Match'],
                  delete o['x-cos-copy-source-If-None-Match'],
                  n.emit('get_chunk_size_finish');
              }),
              i.headObject({ Bucket: f, Region: h, Key: g }, function (o, r) {
                if (o) o.statusCode && 404 === o.statusCode ? t({ ErrorStatus: g + ' Not Exist' }) : t(o);
                else if (void 0 !== (y = e.FileSize = r.headers['content-length']) && y)
                  if (((x = u.throttleOnProgress.call(i, y, e.onProgress)), y <= v))
                  ...
                  t({ error: 'get Content-Length error, please add "Content-Length" to CORS ExposeHeader setting.' });
              });
          } else t({ error: 'CopySource format error' });
        },
      };
      e.exports.init = function (e, t) {
        t.transferToTaskMethod(C, 'sliceUploadFile'),
          u.each(C, function (t, n) {
